...
const PERMISSIONS = [
  ...
  { key: "crm.service_enquiry.read", label: "View CRM service enquiries", group: "CRM" },
  { key: "crm.service_enquiry.assign", label: "Assign CRM service enquiries", group: "CRM" },
  { key: "crm.service_enquiry.manage", label: "Manage CRM service enquiries", group: "CRM" },
  { key: "crm.service_enquiry.audit", label: "Review CRM service enquiry audit history", group: "CRM" },
  { key: "crm.freight_pricing.read", label: "View freight pricing workflow", group: "CRM" },
  { key: "crm.freight_pricing.manage", label: "Manage freight pricing workflow", group: "CRM" },
  { key: "crm.customs_pricing.read", label: "View customs pricing workflow", group: "CRM" },
  { key: "crm.customs_pricing.manage", label: "Manage customs pricing workflow", group: "CRM" },
  ...
  { key: "accounting.post", label: "Post approved Accounting requests", group: "Accounting" },
  { key: "accounting.reverse", label: "Reverse posted Accounting journals", group: "Accounting" },
  { key: "accounting.replace", label: "Replace reversed Accounting journals", group: "Accounting" },
  { key: "accounting.period_lock.request", label: "Request Accounting period locks or reopening", group: "Accounting" },
  { key: "accounting.period_lock.approve", label: "Approve Accounting period locks or reopening", group: "Accounting" },
  ...
  { key: "accounting.integration.post", label: "Post through a trusted Accounting integration", group: "Accounting" },
  { key: "accounting.integration.retry", label: "Retry or review Accounting integration requests", group: "Accounting" },
  { key: "accounting.integration.manual-review", label: "Review Accounting integration failures", group: "Accounting" },
  { key: "accounting.ledger.read", label: "Read the Accounting ledger", group: "Accounting" },
  { key: "accounting.audit.read", label: "Read Accounting audit lineage", group: "Accounting" },
  ...
  { key: "accounting.correction.read", label: "View Accounting corrections", group: "Accounting" },
  { key: "accounting.note.read", label: "View Accounting customer/vendor notes", group: "Accounting" },
  { key: "accounting.quotation.read", label: "View quotations", group: "Accounting" },
  { key: "accounting.quotation.create", label: "Create quotations", group: "Accounting" },
  { key: "accounting.quotation.edit", label: "Edit quotation drafts", group: "Accounting" },
  { key: "accounting.quotation.submit", label: "Submit quotations for approval", group: "Accounting" },
  { key: "accounting.quotation.approve", label: "Approve quotations", group: "Accounting" },
  { key: "accounting.quotation.decide", label: "Record quotation win/loss decisions", group: "Accounting" },
  { key: "accounting.quotation.send", label: "Send quotations to customers", group: "Accounting" },
  { key: "accounting.quotation.cancel", label: "Cancel quotations", group: "Accounting" },
  { key: "accounting.quotation.manage", label: "Manage quotation configuration", group: "Accounting" },
  { key: "accounting.payroll-payment.integrate", label: "Consume approved payroll payments", group: "Accounting" },
  { key: "accounting.payroll-correction.integrate", label: "Consume approved payroll corrections", group: "Accounting" },
  { key: "accounting.payroll-payment.sensitive.read", label: "Read sensitive payroll payment detail", group: "Accounting" },
  { key: "accounting.depreciation.integrate", label: "Consume approved depreciation runs", group: "Accounting" },
  { key: "accounting.recurring-template.admin", label: "Administer recurring Accounting templates", group: "Accounting" },
  ...
  { key: "accounting.capability-policy.read", label: "Read Accounting capability policies", group: "Accounting" },
  { key: "accounting.capability-policy.manage", label: "Manage Accounting capability policy drafts", group: "Accounting" },
  { key: "accounting.capability-policy.approve", label: "Approve Accounting capability policies", group: "Accounting" },
  ...
  { key: "cha.checklist.view", label: "View Checklist Workflow", group: "CHA" },
  { key: "cha.checklist.upload", label: "Upload Checklist File", group: "CHA" },
  { key: "cha.checklist.edit", label: "Edit/Reupload Checklist File", group: "CHA" },
  { key: "cha.checklist.view_file", label: "View Checklist File", group: "CHA" },
  { key: "cha.checklist.internal_approve", label: "Internal Approve Checklist", group: "CHA" },
  { key: "cha.checklist.customer_approve", label: "Customer Approve Checklist", group: "CHA" },
  { key: "cha.checklist.reject", label: "Reject Checklist", group: "CHA" },
  { key: "cha.checklist.move_to_filing", label: "Move Checklist To Filing", group: "CHA" },
...
const SYSTEM_ROLES: Record<string, string[]> = {
  ...
  Management: [
    ...
    "cha.additional_data.view", "cha.additional_data.edit", "cha.additional_data.proceed",
    "cha.checklist.view", "cha.checklist.view_file", "cha.checklist.internal_approve", "cha.checklist.customer_approve", "cha.checklist.reject", "cha.checklist.move_to_filing",
  ...
  Manager: [
    ...
    "cha.additional_data.view", "cha.additional_data.proceed", "cha.checklist.manager_approve",
    "cha.checklist.view", "cha.checklist.view_file", "cha.checklist.internal_approve", "cha.checklist.customer_approve", "cha.checklist.reject", "cha.checklist.move_to_filing",
  ...
  Employee: [
    ...
    "cha.additional_data.view", "cha.additional_data.edit", "cha.additional_data.proceed",
    "cha.checklist.view", "cha.checklist.upload", "cha.checklist.edit", "cha.checklist.view_file", "cha.checklist.prepare",
