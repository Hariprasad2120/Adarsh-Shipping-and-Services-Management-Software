...
assert(
  pageFiles.length === 213,
  `Expected 213 routes, found ${pageFiles.length}.`,
);
assert(
...
console.log(
  "Verified 213 routes, 14 layouts, universal production shells, 12 customer portal routes, three themes, one-scroller shell boundaries, responsive portal navigation, production-only CSS imports, legacy component removal, semantic colors/elevation/radii, and zero pending routes.",
);
