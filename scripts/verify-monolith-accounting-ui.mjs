...
assert(
  routes.length === 32,
  `Expected 32 Accounting routes, found ${routes.length}.`,
);
...
console.log(
  `Verified ${routes.length} Accounting routes, shared controls and responsive styles, protected workflow signals, and the ${archiveFiles.length}-file legacy archive.`,
);
