        ...
        <div className="space-y-4">
          ...
          <div className="mnx-accounting-form-grid mnx-accounting-form-grid-wide">
            ...
            {(kind === "sales-credit" || kind === "sales-debit" || kind === "purchase-credit" || kind === "purchase-debit") && (
              <>
                <AccountingField label="Original Invoice" required>
                  <AccountingSelect
                    required
                  ...
                  >
                    ...
                    {originalInvoices
                      .filter((inv) => {
                        if (kind.startsWith("sales")) return !inv.supplierId;
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[var(--mnx-surface-nav)] border-b border-[var(--mnx-border)] text-left text-xs font-bold text-[var(--mnx-text-muted)] uppercase">
                <th className="p-3 min-w-[280px]">Item Details</th>
                <th className="p-3 min-w-[120px]">Unit</th>
                <th className="p-3 min-w-[100px] text-right">Quantity</th>
                <th className="p-3 min-w-[120px] text-right">Rate</th>
                <th className="p-3 min-w-[120px]">Tax</th>
                <th className="p-3 min-w-[120px]">TDS</th>
                <th className="p-3 min-w-[100px] text-right">Amount</th>
              ...
              {items.map((item, index) => (
                <tr key={index} className="border-b border-[var(--mnx-border)] hover:bg-[var(--mnx-surface-hover)] align-top">
                  <td className="p-3">
                    ...
                    {/* Pre-filled Currency Suggestion & Exchange rate editing */}
                    {kind === "sales" && (
                      <div className="flex gap-3 mt-2 text-xs">
                        <div className="flex-1">
                          <label className="text-[10px] text-[var(--mnx-text-muted)] font-semibold block mb-0.5">Currency</label>
                          <AccountingSelect
                            value={item.currency}
                            onChange={(event) => {
                              ...
                              let suggestedRate = "1";
                              if (nextCurrency !== "INR") {
                                const rateObj = exchangeRates.find(r => r.from === nextCurrency && r.to === "INR");
                        ...
                        <div className="flex-1">
                          <label className="text-[10px] text-[var(--mnx-text-muted)] font-semibold block mb-0.5">Exchange Rate</label>
                          <AccountingInput
                            required
                  ...
                  <td className="p-3">
                    <div className="flex flex-col gap-1">
                      ...
                      <button
                        ...
                        className="text-[10px] text-blue-500 hover:underline text-left font-semibold"
                      >
                        + Create unit
                      </button>
                    </div>
                  ...
                  <td className="p-3 text-right font-medium text-[var(--mnx-text)]">
