...
export const metadata = { title: "Events — CRM" };
...
export default async function CrmEventsPage() {
  ...
  try {
    ...
    return <CrmPermissionState description="You do not have permission to manage CRM events." />;
  }

  const raw = await listActivities(orgId, { type: "EVENT" });
  ...
  return <ActivityWorkspace kind="EVENT" rows={rows} />;
}
