...
const STATUS_COLORS: Record<string, string> = {
  ...
  CLOSED: "bg-surface-container-high text-on-surface-variant dark:bg-slate-800/40 dark:text-slate-400 border border-outline-variant dark:border-slate-700/30",
};
    ...
    <div className="space-y-6">
      ...
      <div>
        <Link href="/crm/tickets" passHref>
          <button className="flex items-center gap-2 text-sm font-semibold text-on-surface-variant hover:text-slate-900 dark:hover:text-white transition">
          ...
          <Card className="border-0 shadow-sm bg-surface">
            ...
            <CardContent className="p-0">
              ...
              {ticket.status !== "CLOSED" ? (
                ...
                <div className="border-t border-outline-variant/60 p-5 bg-surface-container-high dark:bg-slate-800/30 text-center text-on-surface-variant text-xs font-semibold flex items-center justify-center gap-1.5">
