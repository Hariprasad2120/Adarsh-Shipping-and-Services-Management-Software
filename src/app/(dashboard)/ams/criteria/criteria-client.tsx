    ...
    <div className="space-y-6 pb-10">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <article
            key={label}
            className="mnx-performance-surface mnx-accent-edge group relative overflow-hidden rounded-[var(--mn-radius-panel)] border border-mono-border/20 bg-mono-card p-5 shadow-[var(--mn-shadow-panel)] transition duration-300 hover:-translate-y-1 hover:border-mono-border "
          >
