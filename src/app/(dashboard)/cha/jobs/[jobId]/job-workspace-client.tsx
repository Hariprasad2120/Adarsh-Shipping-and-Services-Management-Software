...
type FilingNodeDraft = {
  ...
  filingToggleStateDetails: Record<
    string,
    { isEnabled: boolean; state: Record<string, unknown> | null }
  >;
...
function getDefaultTabForStage(stage: string): WorkspaceTab {
  ...
  if (stage === "CHECKLIST_PREPARATION" || stage === "CHECKLIST_APPROVAL")
    return "checklist";
  ...
  const normalized = value
    .map((entry) => {
      ...
      const containerNumber =
        "containerNumber" in entry && typeof entry.containerNumber === "string"
...
function normalizeAdditionalDataDraft(
  value: unknown,
): AdditionalDataDraft | null {
  ...
  return {
    vesselInwardDate:
      typeof draft.vesselInwardDate === "string" ? draft.vesselInwardDate : "",
    importGeneralManifest:
      typeof draft.importGeneralManifest === "string"
        ? draft.importGeneralManifest
        : "",
    exportGeneralManifest:
      typeof draft.exportGeneralManifest === "string"
        ? draft.exportGeneralManifest
        : "",
    customManifestValue:
      typeof draft.customManifestValue === "string"
        ? draft.customManifestValue
        : "",
    ...
    deliveryOrderValidity:
      typeof draft.deliveryOrderValidity === "string"
        ? draft.deliveryOrderValidity
        : "",
  };
}
...
function normalizeFilingNodeDraft(value: unknown): FilingNodeDraft | null {
  ...
  return {
    checklistResponses:
      draft.checklistResponses && typeof draft.checklistResponses === "object"
        ? draft.checklistResponses
        : {},
    filingFieldValues:
      draft.filingFieldValues && typeof draft.filingFieldValues === "object"
        ? draft.filingFieldValues
        : {},
    filingToggleStates:
      draft.filingToggleStates && typeof draft.filingToggleStates === "object"
        ? draft.filingToggleStates
        : {},
    filingToggleStateDetails:
      draft.filingToggleStateDetails &&
      typeof draft.filingToggleStateDetails === "object"
        ? draft.filingToggleStateDetails
        : {},
    filingQueryDetails:
      typeof draft.filingQueryDetails === "string"
        ? draft.filingQueryDetails
        : "",
    filingQueryOfficerName:
      typeof draft.filingQueryOfficerName === "string"
        ? draft.filingQueryOfficerName
        : "",
    filingQueryReceivedAt:
      typeof draft.filingQueryReceivedAt === "string"
        ? draft.filingQueryReceivedAt
        : "",
    filingQueryReferenceNumber:
      typeof draft.filingQueryReferenceNumber === "string"
        ? draft.filingQueryReferenceNumber
        : "",
    filingQueryResponderNames:
      draft.filingQueryResponderNames &&
      typeof draft.filingQueryResponderNames === "object"
        ? draft.filingQueryResponderNames
        : {},
    filingQueryStatusUpdates:
      draft.filingQueryStatusUpdates &&
      typeof draft.filingQueryStatusUpdates === "object"
        ? draft.filingQueryStatusUpdates
        : {},
    filingQueryTitle:
      typeof draft.filingQueryTitle === "string" ? draft.filingQueryTitle : "",
    nodeRemarks: typeof draft.nodeRemarks === "string" ? draft.nodeRemarks : "",
    nodeDelayRemarks:
      typeof draft.nodeDelayRemarks === "string" ? draft.nodeDelayRemarks : "",
    selectedNextNodeKey:
      typeof draft.selectedNextNodeKey === "string"
        ? draft.selectedNextNodeKey
        : "",
  };
}

function mergeFilingChecklistResponses(
  serverResponses: Record<
    string,
    {
      isChecked: boolean;
      remarks?: string;
  ...
  for (const [itemId, draftResponse] of Object.entries(draftResponses)) {
    ...
    merged[itemId] = {
      ...
      remarks: draftResponse.remarks?.trim()
        ? draftResponse.remarks
        : serverResponse.remarks,
      fileKey: draftResponse.fileKey || serverResponse.fileKey,
      delayRemarks: draftResponse.delayRemarks?.trim()
        ? draftResponse.delayRemarks
        : serverResponse.delayRemarks,
    };
  }
...
function AdditionalDataStatCard({
  ...
  return (
    <div className="mnx-bg-surface mnx-border mnx-bg-surface mnx-border mnx-border-accent rounded-xl border mnx-border mnx-bg-surface p-3 shadow-sm">
      ...
      <p
        className={`mt-1 text-sm mnx-text-primary ${numeric ? "mnx-numeric" : ""}`}
      >
        {value}
      </p>
    </div>
  ...
  return (
    <div className="flex flex-wrap items-start justify-between gap-3">
      <WorkspaceSectionHeading
        ...
        title={title}
        description={
          description ?? "Complete the controlled operation for this job stage."
        }
      />
...
function WarningNoteToggle({
  ...
  return (
    <div className="group/warning-note relative shrink-0">
      ...
      <div
        className={`mnx-floating-surface mnx-cha-popover absolute right-0 top-full z-20 mt-2 w-[20rem] max-w-[calc(100vw-2rem)] px-4 py-3 transition-all duration-200 ${
          open
      ...
      >
        ...
        <p className="mt-2 text-sm leading-relaxed mnx-text-primary">
          {description}
        </p>
      </div>
    </div>
...
function MilestoneCard({
  ...
  return (
    <div
      ...
      className={`scroll-mt-32 overflow-hidden rounded-xl border mnx-bg-surface transition-all duration-500 ${cardBorderClass} ${
        isSpotlit ? "ring-2 mnx-border-accent mnx-shadow-panel" : ""
      }`}
    ...
    >
      <div
        ...
        className={`select-none flex flex-col gap-4 px-5 py-5 lg:flex-row lg:items-center lg:justify-between ${
          isLocked ? "cursor-not-allowed" : "cursor-pointer mnx-hover-accent"
        }`}
      >
        <div className="flex min-w-0 items-center gap-4 lg:flex-1">
          <span
            className={`flex size-11 shrink-0 items-center justify-center rounded-full text-xs transition-all ${
              isCompleted
          ...
          <div className="grid min-w-0 flex-1 grid-cols-[4px_minmax(0,1fr)] items-start gap-x-4 gap-y-1">
              ...
              <Badge
                ...
                className={`uppercase tracking-wider text-[10px] ${
                  isCompleted || isActive
                    ? "mnx-border-accent !bg-transparent mnx-text-accent"
                    : ""
                }`}
              >
                {statusLabel ??
            ...
            <span
              className="h-7 w-1 rounded-sm mnx-bg-accent-soft"
              aria-hidden="true"
            />
            <div>
            ...
            <div aria-hidden="true" />
            <p className="max-w-xl text-sm leading-snug mnx-text-muted">
              {description}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 self-end lg:self-center">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <div className="rounded-xl border mnx-border mnx-bg-soft px-3 py-1.5 text-right">
              <p className="text-[9px] font-bold uppercase tracking-wider mnx-text-muted">
                Readiness
              </p>
              <p className="text-[11px] font-medium mnx-text-primary">
                {validationState}
              </p>
            </div>
            <div className="rounded-xl border mnx-border mnx-bg-soft px-3 py-1.5 text-right">
              ...
              <p className="text-[11px] font-bold mnx-text-accent mnx-numeric">
                {percentage}%
              </p>
            </div>
            <div className="rounded-xl border mnx-border mnx-bg-soft px-3 py-1.5 text-right">
...
function FilingWorkflowStatusBanner({
  ...
  const statusLabel =
    activeStatusLabel ||
    (isCompleting ? "Completing..." : isBlocked ? "Blocked" : "In Progress");
  ...
  const latestCompletedTimeLabel = latestCompletedStep?.completedAt
    ? new Date(latestCompletedStep.completedAt).toLocaleTimeString("en-IN", {
        hour: "2-digit",
        minute: "2-digit",
      })
    : null;
  ...
  return (
    <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_32px_minmax(0,1fr)_32px_minmax(0,1fr)] lg:items-center">
        ...
        <div className="min-w-0 space-y-0.5">
          ...
          <p className="truncate text-xs mnx-text-muted">
            {latestCompletedDateLabel
              ? [latestCompletedDateLabel, latestCompletedTimeLabel]
                  .filter(Boolean)
                  .join(" | ")
              : "First active stage"}
          </p>
      ...
      <div className="relative flex min-h-[92px] min-w-0 items-center gap-3 overflow-hidden rounded-xl border mnx-border-accent mnx-bg-accent-soft px-4 py-3">
        <span
          className="absolute inset-x-4 top-0 h-0.5 rounded-b-full mnx-bg-accent-soft"
          aria-hidden="true"
        />
        ...
        <div className="min-w-0 space-y-0.5">
          ...
          <p className="truncate text-sm font-medium mnx-text-primary">
            {activeNodeSequence ? (
              <span className="mnx-numeric mr-1.5 mnx-text-accent">
                {String(activeNodeSequence).padStart(2, "0")}.
              </span>
            ) : null}
            {activeNodeName}
          </p>
...
function SlideToComplete({
  ...
  const actionVerb = text.toLowerCase().includes("skip")
    ? "skip"
  ...
  const actionVerbPresent =
    actionVerb === "skip"
      ...
      : actionVerb === "file"
        ? "file"
        : "complete";
  const actionVerbProgress =
    actionVerb === "skip"
      ? "Skipping..."
      : actionVerb === "file"
        ? "Filing..."
        : "Completing...";
  const actionVerbGerund =
    actionVerb === "skip"
      ? "skipping"
      : actionVerb === "file"
        ? "filing"
  ...
  const handlePointerMove = (event: React.PointerEvent<HTMLDivElement>) => {
    ...
    const nextPos = Math.max(
      0,
      Math.min(event.clientX - startOffsetRef.current, maxDistance),
    );
  ...
  const stepKeyboardProgress = async (
    direction: "forward" | "backward" | "complete",
  ) => {
    if (disabled || isSubmitting) return;
  ...
  return (
    ...
    >
      ...
      >
        <span className="animate-[workflow-chevron_1.15s_ease-in-out_infinite] font-semibold">
          {">"}
        </span>
        <span className="ml-2 animate-[workflow-chevron_1.15s_ease-in-out_infinite_0.12s] font-semibold">
          {">"}
        </span>
        <span className="ml-2 animate-[workflow-chevron_1.15s_ease-in-out_infinite_0.24s] font-semibold">
          {">"}
        </span>
      </div>
      <div
        ...
        style={{
          transform: `translateX(${sliderPos}px) scale(${isDragging ? 1.04 : 1})`,
        }}
      >
        <ArrowRight
          size={22}
          className="mnx-text-muted shrink-0"
          style={{ color: "var(--mnx-surface)", stroke: "var(--mnx-surface)" }}
        />
      </div>
      <div
      ...
      >
        <div className="min-w-0 justify-self-center text-center leading-none">
          <p className="text-[10px] font-normal uppercase tracking-[0.12em] mnx-text-accent">
            {isSubmitting ? actionVerbProgress : "Slide to"}
          </p>
          <p className="mt-1 truncate text-sm font-normal uppercase tracking-[0.04em] mnx-text-primary">
            <span className="mnx-text-accent">
              {isSubmitting ? actionVerbGerund : actionVerbPresent}
            </span>{" "}
            {actionObject}
          </p>
        </div>
          ...
          <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs mnx-text-muted">
                ...
                <span className="mnx-numeric">
                  {attachment.uploadedAt
                    ? `Uploaded ${new Date(attachment.uploadedAt).toLocaleDateString("en-IN")}`
                    : "Uploaded"}
                </span>
                {validitySummary ? (
                  <span
            ...
            <div className="flex shrink-0 items-start gap-2">
              <Button
                ...
                className={`mnx-plain inline-flex items-center gap-1.5 rounded-xl border px-2.5 py-1 text-[10px] font-medium uppercase tracking-[0.12em] transition-all ${
                  validityEnabled
              ...
              >
                <span
                  className={`relative inline-flex h-3.5 w-6 items-center rounded-full border transition-all ${
                    validityEnabled
                ...
                >
                  <span
                    className={`absolute top-[1px] h-2.5 w-2.5 rounded-full mnx-bg-surface shadow-sm transition-transform ${
                      validityEnabled
                        ? "translate-x-[12px]"
                        : "translate-x-[1px]"
                    }`}
              ...
              >
                <X
                  className="size-3.5 shrink-0 transition-transform duration-200 group-hover:rotate-90"
                  aria-hidden={true}
                />
              </Button>
            </div>
...
export function JobWorkspaceClient({
  ...
  const [expandedStageKey, setExpandedStageKey] = useState<string | null>(
    () => {
      if (initialTab) {
        ...
        if (initialTab === "filing")
          return job.stage === "FILED" ? "FILED" : "FILING";
      }
  ...
  useEffect(() => {
    ...
    const target = document.getElementById(
      `workflow-stage-${pendingStage.toLowerCase()}`,
    );
    if (!target) {
      return;
    }
  ...
  const filteredManagers = useMemo(() => {
    ...
    const branchManagers = managers.filter(
      (m: any) => m.branchId === job.branchId,
    );
    return branchManagers.length > 0 ? branchManagers : managers;
  }, [managers, job.branchId]);

  const [section49Flag, setSection49Flag] = useState<any>(
    job.filingSection49Flag ?? null,
  );
  ...
  const [section49ValidityDate, setSection49ValidityDate] = useState(
    job.filingSection49Flag?.validityDate
      ? job.filingSection49Flag.validityDate.slice(0, 10)
      : "",
  );
  const [section49ExtensionDate, setSection49ExtensionDate] = useState("");
  const [section49ExtensionFile, setSection49ExtensionFile] =
    useState<File | null>(null);
  const [openWarningNote, setOpenWarningNote] = useState<
    "bill-filing" | "query-processing" | null
  >(null);
  const additionalDataStageAvailable = job.stage !== "DOCUMENT_COLLECTION";
  const additionalDataManualSaveStorageKey =
    getAdditionalDataManualSaveStorageKey(job.id);
  const [hasManuallySavedAdditionalData, setHasManuallySavedAdditionalData] =
    useState(false);
  ...
  useEffect(() => {
    ...
    try {
      setHasManuallySavedAdditionalData(
        localStorage.getItem(additionalDataManualSaveStorageKey) === "true",
      );
    } catch {
      setHasManuallySavedAdditionalData(false);
    }
  ...
  useEffect(() => {
    setIsAdditionalDataEditing(
      job.stage === "ADDITIONAL_DATA" && !hasManuallySavedAdditionalData,
    );
  }, [hasManuallySavedAdditionalData, job.id, job.stage]);

  const [dueDateWarnings, setDueDateWarnings] = useState<
    DueDateWarningViewModel[]
  >(job.dueDateWarnings ?? []);
  ...
  const visibleDocumentRequirements = useMemo(() => {
    return documentRequirements.filter((req: any) => {
      ...
      const hasPersistedState =
        req.status !== "PENDING" ||
        (Array.isArray(req.versions) && req.versions.length > 0) ||
        !!req.exception;
  ...
  }, [documentRequirements, section49Flag?.isEnabled]);

  const getDisplayWorkflowRequirement = useCallback((rawReq: any) => {
    const chaCurrentVersion =
      rawReq.versions?.find((version: any) => version.isCurrent) ||
      rawReq.versions?.[0] ||
      null;
    ...
    return {
      ...rawReq,
      status:
        customerSubmission.status === "ACCEPTED"
          ? "UPLOADED"
          : customerSubmission.status,
      ...
      versions: [
        {
          ...
          uploadedBy: {
            name: customerSubmission.portalUser?.name || "Customer Portal",
          },
  ...
  const bulkNaEligibleRequirements = useMemo(
    () =>
      visibleDocumentRequirements.filter(
        (req: any) =>
          req.status !== "UPLOADED" && req.status !== "NOT_AVAILABLE",
      ),
    [visibleDocumentRequirements],
  );

  const firstUnresolvedMandatoryDocumentId = useMemo(() => {
    const unresolvedRequirement = visibleDocumentRequirements.find(
      (req: any) => {
  ...
  const [documentsFilterMode, setDocumentsFilterMode] = useState<
    "ALL" | "PENDING" | "UPLOADED" | "DECLARED_EXEMPTION" | "MARKED_NA"
  >("ALL");
  const [selectedDocumentRequirementId, setSelectedDocumentRequirementId] =
    useState<string | null>(null);
  const [isDocumentDrawerOpen, setIsDocumentDrawerOpen] = useState(true);
  const [documentDrawerTab, setDocumentDrawerTab] = useState<
    "preview" | "details"
  >("preview");
  ...
  const updatePreviewOffset = useCallback(() => {
    ...
    setTimeout(() => {
      const cardElement =
        documentRequirementCardRefs.current[selectedDocumentRequirementId];
    ...
    return visibleDocumentRequirements
      ...
      .filter((rawReq: any) => {
        ...
        const currentVersion =
          req.versions.find((version) => version.isCurrent) || req.versions[0];
        const matchesQuery =
          !normalizedQuery ||
          [
            req.name,
        ...
        if (documentsFilterMode === "UPLOADED")
          return (
            !!currentVersion &&
            ![
              "REUPLOAD_REQUIRED",
        ...
        if (documentsFilterMode === "DECLARED_EXEMPTION")
          return !!req.exception && req.exception.reason !== "N/A";
        if (documentsFilterMode === "MARKED_NA")
          return (
  ...
  const topRequirementCards = useMemo(
    () =>
      filteredWorkflowDocuments.filter((req: any) => {
        const currentVersion =
          req.versions.find(
            (version: WorkflowDocumentVersion) => version.isCurrent,
          ) || req.versions[0];
        return (
          !currentVersion ||
          ["REUPLOAD_REQUIRED", "CLARIFICATION_REQUIRED", "REJECTED"].includes(
            req.status,
          )
        );
      }),
  ...
  const uploadedWorkflowDocuments = useMemo(
    () =>
      filteredWorkflowDocuments.filter((req: any) => {
        const currentVersion =
          req.versions.find((version: any) => version.isCurrent) ||
          req.versions[0];
        return (
          !!currentVersion &&
          !["REUPLOAD_REQUIRED", "CLARIFICATION_REQUIRED", "REJECTED"].includes(
  ...
  const selectedWorkflowDocumentRequirement = useMemo(() => {
    const matchingRequirement = filteredWorkflowDocuments.find(
      (req: WorkflowDocumentRequirement) =>
        req.id === selectedDocumentRequirementId,
    );
    if (matchingRequirement) return matchingRequirement;
    return (
      uploadedWorkflowDocuments[0] ??
      topRequirementCards[0] ??
      filteredWorkflowDocuments[0] ??
      null
    );
  }, [
    filteredWorkflowDocuments,
    ...
    topRequirementCards,
    uploadedWorkflowDocuments,
  ]);

  const selectedWorkflowDocumentVersion = useMemo(() => {
    if (!selectedWorkflowDocumentRequirement) return null;
    return (
      selectedWorkflowDocumentRequirement.versions.find(
        (version: WorkflowDocumentVersion) => version.isCurrent,
      ) ||
      selectedWorkflowDocumentRequirement.versions[0] ||
      null
    );
  }, [selectedWorkflowDocumentRequirement]);
  const getRequirementCategoryName = (
    requirement: WorkflowDocumentRequirement,
  ) =>
    requirement.requirementItem?.category?.name ||
    requirement.category ||
    "General Documents";
  const getRequirementCategorySortOrder = (
    requirement: WorkflowDocumentRequirement,
  ) => {
    const rawOrder =
      (
        requirement.requirementItem?.category as
          { sortOrder?: number | null } | undefined
      )?.sortOrder ?? null;
    return typeof rawOrder === "number" ? rawOrder : Number.MAX_SAFE_INTEGER;
  };
  const getRequirementItemSortOrder = (
    requirement: WorkflowDocumentRequirement,
  ) => {
    const rawOrder =
      (requirement.requirementItem as { sortOrder?: number | null } | undefined)
        ?.sortOrder ?? null;
    return typeof rawOrder === "number" ? rawOrder : Number.MAX_SAFE_INTEGER;
  };
  const sortWorkflowRequirements = useCallback(
    (left: WorkflowDocumentRequirement, right: WorkflowDocumentRequirement) => {
      const categoryOrderDiff =
        getRequirementCategorySortOrder(left) -
        getRequirementCategorySortOrder(right);
      if (categoryOrderDiff !== 0) return categoryOrderDiff;

      const categoryNameDiff = getRequirementCategoryName(left).localeCompare(
        getRequirementCategoryName(right),
      );
      if (categoryNameDiff !== 0) return categoryNameDiff;

      const itemOrderDiff =
        getRequirementItemSortOrder(left) - getRequirementItemSortOrder(right);
  ...
  const groupedPendingWorkflowDocuments = useMemo(() => {
    ...
    return Array.from(grouped.entries())
      .map(([categoryName, requirements]) => ({
        ...
        sortOrder: requirements.reduce(
          (lowest, current) =>
            Math.min(lowest, getRequirementCategorySortOrder(current)),
  ...
  const [uploadDocumentModalReqId, setUploadDocumentModalReqId] = useState<
    string | null
  >(null);
  const [bulkNaConfirmOpen, setBulkNaConfirmOpen] = useState(false);
  const [isCustomDocumentModalOpen, setIsCustomDocumentModalOpen] =
    useState(false);
  const [customDocumentName, setCustomDocumentName] = useState("");
  const [customDocumentFile, setCustomDocumentFile] = useState<File | null>(
    null,
  );
  const [customerApprovalNow, setCustomerApprovalNow] = useState(() =>
    Date.now(),
  );
  const activeExceptionRequirement = activeDocReqId
    ? (documentRequirements.find((req: any) => req.id === activeDocReqId) ??
      null)
    : null;
  const section49Requirement =
    visibleDocumentRequirements.find((req: any) => req.name === "Section 49") ??
    null;
  const section49CurrentVersion =
    section49Requirement?.versions.find((version: any) => version.isCurrent) ??
    section49Requirement?.versions?.[0] ??
    null;
  const section49EffectiveValidityDate =
    section49Flag?.validityDate ||
    section49CurrentVersion?.validityDate ||
    null;
  const section49ValiditySummary = getValiditySummary(
  ...
  const [highlightedDocumentReqId, setHighlightedDocumentReqId] = useState<
    string | null
  >(null);
  const documentRequirementCardRefs = useRef<
    Record<string, HTMLDivElement | null>
  >({});
  const uploadDocumentModalRequirement = uploadDocumentModalReqId
    ? (documentRequirements.find(
        (req) => req.id === uploadDocumentModalReqId,
      ) ?? null)
    : null;
  ...
  useEffect(() => {
    ...
    const handleDocumentPointerDown = (event: PointerEvent) => {
      ...
      const clickedInsideDocumentCard = Object.values(
        documentRequirementCardRefs.current,
      ).some((cardElement) => cardElement?.contains(target));
      const clickedInsidePreviewDrawer =
        previewDrawerRef.current?.contains(target);
      ...
      if (
        clickedInsideDocumentCard ||
        clickedInsidePreviewDrawer ||
        clickedInsideDropzone ||
  ...
  useEffect(() => {
    ...
    if (
      focusField === "deliveryOrderValidity" ||
      focusField === "deliveryOrderExtensionDate"
    ) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      const card =
        documentRequirementCardRefs.current[highlightedDocumentReqId];
      if (card) {
  ...
  useEffect(() => {
    if (
      highlightedDocumentReqId &&
      highlightedDocumentReqId !== firstUnresolvedMandatoryDocumentId
    ) {
  ...
  const [vesselInwardDate, setVesselInwardDate] = useState(
    job.additionalData?.vesselInwardDate
      ? job.additionalData.vesselInwardDate.slice(0, 10)
      : "",
  );
  const [importGeneralManifest, setImportGeneralManifest] = useState(
    job.additionalData?.importGeneralManifest !== null &&
      job.additionalData?.importGeneralManifest !== undefined
  ...
  const [exportGeneralManifest, setExportGeneralManifest] = useState(
    job.additionalData?.exportGeneralManifest !== null &&
      job.additionalData?.exportGeneralManifest !== undefined
      ? String(job.additionalData.exportGeneralManifest)
      : "",
  );
  const [customManifestValue, setCustomManifestValue] = useState(
    job.additionalData?.customManifestValue !== null &&
      job.additionalData?.customManifestValue !== undefined
  ...
  const [mblNumber, setMblNumber] = useState(
    job.additionalData?.mblNumber || "",
  );
  const [hblNumber, setHblNumber] = useState(
    job.additionalData?.hblNumber || "",
  );
  ...
  const additionalDataDraftStorageKey = getAdditionalDataDraftStorageKey(
    job.id,
  );
  const initialAdditionalDataDraft: AdditionalDataDraft = {
    vesselInwardDate: job.additionalData?.vesselInwardDate
      ? job.additionalData.vesselInwardDate.slice(0, 10)
      : "",
    importGeneralManifest:
      job.additionalData?.importGeneralManifest !== null &&
    ...
    customManifestValue:
      ...
      job.additionalData?.customManifestValue !== undefined
        ? String(job.additionalData.customManifestValue)
        : "",
    containerEntries: normalizeContainerEntries(
      job.additionalData?.containerDetails,
    ),
  ...
  const [customerMailAttachments, setCustomerMailAttachments] = useState<
    File[]
  >([]);
  ...
  const filingShipmentType =
    job.shipmentType?.name?.trim() || job.filing?.filingShipmentType || "";
  ...
  const [filingCompletionAnnouncement, setFilingCompletionAnnouncement] =
    useState("");
  const [filingValidationWarning, setFilingValidationWarning] =
    useState<FilingValidationWarning | null>(null);
  const [checklistResponses, setChecklistResponses] = useState<
    ...
    >
  >({});
  const [filingFieldValues, setFilingFieldValues] = useState<
    Record<string, string>
  >({});
  const [filingToggleStates, setFilingToggleStates] = useState<
    Record<string, boolean>
  >({});
  const [filingToggleStateDetails, setFilingToggleStateDetails] = useState<
    Record<
      string,
      { isEnabled: boolean; state: Record<string, unknown> | null }
    >
  ...
  const [filingQueryReferenceNumber, setFilingQueryReferenceNumber] =
    useState("");
  const [filingQueryOfficerName, setFilingQueryOfficerName] = useState("");
  const [attachmentValidityDrafts, setAttachmentValidityDrafts] = useState<
    Record<string, string>
  >({});
  const [attachmentValidityEditors, setAttachmentValidityEditors] = useState<
    Record<string, boolean>
  >({});
  const [filingQueryReceivedAt, setFilingQueryReceivedAt] = useState("");
  const [filingQueryStatusUpdates, setFilingQueryStatusUpdates] = useState<
    Record<string, string>
  >({});
  const [filingQueryResponderNames, setFilingQueryResponderNames] = useState<
    Record<string, string>
  >({});
  ...
  const [executionTimelineModalOpen, setExecutionTimelineModalOpen] =
    useState(false);
  const [queryProcessingPanelExpanded, setQueryProcessingPanelExpanded] =
    useState(false);
  const [goBackOpen, setGoBackOpen] = useState(false);
  const [goBackMode, setGoBackMode] = useState<"previous" | "return">(
    "previous",
  );
  const [goBackReason, setGoBackReason] = useState("");
  const [selectedJumpBackNodeKey, setSelectedJumpBackNodeKey] = useState("");
  const [blockedPrerequisiteModalOpen, setBlockedPrerequisiteModalOpen] =
    useState(false);
  ...
  const additionalDataAutosaveTimeoutRef = useRef<ReturnType<
    typeof setTimeout
  > | null>(null);
  const filingAutosaveTimeoutRef = useRef<ReturnType<typeof setTimeout> | null>(
    null,
  );
  ...
  const filingDraftStorageKey = activeNodeRun?.id
    ? getFilingNodeDraftStorageKey(job.id, activeNodeRun.id)
    : null;
  const activeWorkflowVersionNode = useMemo(() => {
    if (!activeNodeRun?.nodeKey) return null;
    return (
      filingInstance?.version?.nodes?.find(
        (node: any) => node.key === activeNodeRun.nodeKey,
      ) ?? null
    );
  ...
  useEffect(() => {
    ...
    try {
      if (
        ...
        JSON.stringify(initialAdditionalDataDraft)
      ) {
        localStorage.removeItem(additionalDataDraftStorageKey);
        return;
      }
  ...
  const outgoingEdges = useMemo(() => {
    ...
    return (
      filingInstance.version?.edges?.filter(
        (e: any) => e.sourceKey === activeNodeRun.nodeKey,
      ) || []
    );
  ...
  const targetNodesMap = useMemo(() => {
    ...
    return new Map(
      filingInstance.version?.nodes?.map((n: any) => [n.key, n]) || [],
    );
  }, [filingInstance]);

  const overdueChecklistItems = useMemo(
    () => filingInstance?.overdueItems || [],
    [filingInstance],
  );
  const overdueChecklistCount = overdueChecklistItems.length;
  const activeNodeAttachments = useMemo(
    () =>
      filingInstance?.attachments?.filter(
        (attachment: any) => attachment.nodeRunId === activeNodeRun?.id,
      ) || [],
  ...
  const activeNodeDocumentAttachmentsByKey = useMemo(() => {
    ...
    for (const attachment of activeNodeAttachments) {
      ...
      const currentUploadedAt = current.uploadedAt
        ? new Date(current.uploadedAt).getTime()
        : 0;
      const nextUploadedAt = attachment.uploadedAt
  ...
  const activeChecklistItems = useMemo(
    () =>
      activeNodeRun?.node?.checklistItems?.filter(
  ...
  const checklistAttachmentsByItem = useMemo(() => {
    ...
    const attachments =
      filingInstance?.attachments?.filter(
        (attachment: any) =>
          attachment.nodeRunId === activeNodeRun?.id &&
  ...
  const isLegacyStageChecklistUpload = (item: any) =>
    activeNodeHasConfiguredStageUploads && item.allowsUpload;
  const checklistItemAllowsDirectUpload = (item: any) =>
    item.allowsUpload && !isLegacyStageChecklistUpload(item);
  const currentChecklistItemIndex = useMemo(() => {
    if (activeChecklistItems.length === 0) return -1;

    const getAttachmentCount = (itemId: string) =>
      checklistAttachmentsByItem.get(itemId)?.length || 0;
    const isItemReady = (item: any) => {
      ...
      const overdueMeta = overdueChecklistItems.find(
      ...
      if (
        ...
        (item.minUploads || 0) > 0 &&
        getAttachmentCount(item.id) < item.minUploads
      ) {
        return false;
      }
    ...
    const firstPendingIndex = activeChecklistItems.findIndex(
      (item: any) => !isItemReady(item),
    );
  ...
  const activeNodeQueries = useMemo(
    () =>
      (filingInstance?.queries || []).filter(
        (query: any) => query.nodeRunId === activeNodeRun?.id,
      ),
    [activeNodeRun?.id, filingInstance?.queries],
  );
  const activeNodeQueryMessages = useMemo(() => {
    const activeQueryIds = new Set(
      activeNodeQueries.map((query: any) => query.id),
    );
    return (filingInstance?.queryMessages || []).filter((message: any) =>
      activeQueryIds.has(message.queryId),
    );
  ...
  const activeNodePrerequisiteStatus =
    filingInstance?.activeNodePrerequisiteStatus || null;
  const firstMissingPrerequisiteNodeKey =
    activeNodePrerequisiteStatus?.missingNodeKeys?.[0] || null;
  const firstMissingPrerequisiteNodeName = firstMissingPrerequisiteNodeKey
    ? targetNodesMap.get(firstMissingPrerequisiteNodeKey)?.name ||
      firstMissingPrerequisiteNodeKey
    : null;
  const activeNodeSlaDueDate = activeNodeRun?.slaDueDate
    ? new Date(activeNodeRun.slaDueDate)
    : null;
  const activeNodeIsOverdue =
    !!activeNodeSlaDueDate && activeNodeSlaDueDate.getTime() < Date.now();
  const activeNodeDelayRemarksRequired =
    activeNodeIsOverdue && activeNodeRun?.node?.delayRemarksRequired !== false;
  const activeNodeDelayDays = activeNodeSlaDueDate
    ? Math.max(
        1,
        Math.ceil(
          (Date.now() - activeNodeSlaDueDate.getTime()) / (24 * 60 * 60 * 1000),
        ),
      )
    : 0;
  const pendingBlockedStage = filingInstance?.pendingBlockedStage || null;
  const canResumePendingBlockedStage =
    !!filingInstance?.canResumePendingBlockedStage;
  ...
  const getWorkflowNodeOrder = (nodeKey: string | null | undefined) => {
    ...
    const index = filingInstance.version.nodes.findIndex(
      (node: any) => node.key === nodeKey,
    );
    return index >= 0 ? index : null;
  };
  const activeNodeOrder = getWorkflowNodeOrder(activeNodeRun?.nodeKey);
  const returnToCurrentNodeOrder = getWorkflowNodeOrder(
  ...
  const showReturnToCurrentStageShortcut = Boolean(
    returnToCurrentTarget && activeNodeRun,
  );
  ...
  const activeNodeHasOnlyOptionalChecklistItems =
    ...
    activeChecklistItems.every((item: any) => item.isMandatory === false);
  const isSkippingActiveOptionalNode =
    (!!activeNodeRun?.node?.canBeSkipped ||
      activeNodeHasOnlyOptionalChecklistItems) &&
    activeChecklistItems.every(
      (item: any) => !checklistResponses[item.id]?.isChecked,
    );
  const activeNodeHasConditionalFields = visibleNodeConditionalSections.some(
    (section: any) =>
      Array.isArray(section?.unlocksFields) && section.unlocksFields.length > 0,
  );
  const activeNodeHasConditionalDocuments = visibleNodeConditionalSections.some(
    (section: any) =>
      Array.isArray(section?.unlocksDocuments) &&
      section.unlocksDocuments.length > 0,
  );
  const queryProcessingSection = useMemo(() => {
    return (
      activeNodeConditionalSections.find(
        (section: any) => section?.key === "query_processing",
      ) ||
      activeNodeConditionalSections.find(
        (section: any) =>
          section?.config?.moduleType === "CUSTOMS_QUERY_PROCESSING",
      ) ||
      null
    );
  }, [activeNodeConditionalSections]);
  const queryProcessingEnabled = Boolean(
    queryProcessingSection || activeNodeRun,
  );
  const queryProcessingToggleEnabled = Boolean(
    filingToggleStateDetails.query_processing?.isEnabled,
  );
  const queryProcessingState =
    (filingToggleStateDetails.query_processing?.state as Record<
      string,
      unknown
    > | null) ?? null;
  const queryProcessingActive =
    queryProcessingEnabled && queryProcessingToggleEnabled;
  const queryProcessingStage = useMemo(() => {
    if (!queryProcessingActive) return "DISABLED";
    const persistedStage =
      typeof queryProcessingState?.stage === "string" &&
      queryProcessingState.stage.trim()
  ...
  const latestStageQuery = useMemo(() => {
    ...
    const latestQueryId =
      typeof queryProcessingState?.latestQueryId === "string" &&
      queryProcessingState.latestQueryId.trim()
        ? queryProcessingState.latestQueryId.trim()
        : null;
    if (latestQueryId) {
      const matchedQuery = activeNodeQueries.find(
        (query: any) => query.id === latestQueryId,
      );
  ...
  const primaryQuerySummary =
    activeNodeOpenQueries[0] || latestStageQuery || null;
  const clearedQueryCount = activeNodeQueries.filter(
    (query: any) => query.status === "CLOSED",
  ).length;
  const repliedQueryCount = activeNodeQueries.filter(
    (query: any) => query.status === "REPLIED",
  ).length;
  const queryProcessingResolved =
    !queryProcessingActive ||
    queryProcessingStage === "NO_QUERY" ||
    queryProcessingStage === "CLEARED";
  const isSavingQueryProcessingDecision =
    loading === "filing-toggle-query_processing";
  const filingPrimaryColumnClass = "w-full max-w-[680px] xl:col-start-1";
  const filingCompletionColumnClass =
    "flex h-full w-full flex-col space-y-4 xl:col-start-2 xl:self-stretch";
  const nextWorkflowTargetNode =
    outgoingEdges.length > 0
      ? targetNodesMap.get(outgoingEdges[0].targetKey)
      : null;
  const nextWorkflowTargetLabel =
    nextWorkflowTargetNode?.name ||
  ...
  const filingQueryReceivedLabel =
    typeof queryProcessingState?.queryReceivedAt === "string" &&
    queryProcessingState.queryReceivedAt.trim()
      ? new Date(queryProcessingState.queryReceivedAt).toLocaleDateString(
          "en-IN",
        )
  ...
  const filingSummaryCards = [
    ...
    },
    {
      ...
      note:
        activeNodeOpenQueries[0]?.title ||
        latestStageQuery?.title ||
        "No active cases",
  ...
  const stageSummaryItems = [
    ...
    activeNodeFieldDefinitions.length > 0 || activeNodeHasConditionalFields
      ? "fields"
      : null,
    activeNodeDocumentRequirements.length > 0 ||
  ...
  const highlightedChecklistItem =
    activeChecklistItems[Math.max(currentChecklistItemIndex, 0)] ??
    activeChecklistItems[0] ??
    null;
  const highlightedChecklistPosition =
    activeChecklistItems.length > 0
      ? `Item ${Math.max(currentChecklistItemIndex, 0) + 1} of ${activeChecklistItems.length}`
      : null;
  ...
  const hasPreviousFilingStage =
    ...
    (filingInstance?.nodeRuns || []).some(
      (run: any) =>
        run.status === "COMPLETED" && run.nodeKey !== activeNodeRun.nodeKey,
    );
  ...
  useEffect(() => {
    if (
      ...
      (activeNodePrerequisiteStatus?.missingNodeKeys || []).length > 0
    ) {
  ...
  const [expectedAdvance, setExpectedAdvance] = useState(
    job.customerAdvance?.expectedAmount
      ? Number(job.customerAdvance.expectedAmount)
      : 0,
  );
  const [advanceDueDate, setAdvanceDueDate] = useState(
    job.customerAdvance?.dueDate
      ? job.customerAdvance.dueDate.slice(0, 10)
      : "",
  );
  ...
  const [expandedJobExpenseId, setExpandedJobExpenseId] = useState<
    string | null
  >(job.expenseRequests?.[0]?.id ?? null);
  ...
  const [expenseClarificationId, setExpenseClarificationId] = useState<
    string | null
  >(null);
  ...
  const checklistStageIndex = STAGES.findIndex(
    (s) => s.key === "CHECKLIST_PREPARATION",
  );
  ...
  const customManifestLabel =
    job.jobType?.customManifestLabel || "Custom Manifest";
  const manifestLabel =
  ...
  const filingMovementDirection =
    manifestMovementDirection === "IMPORT" ||
    manifestMovementDirection === "EXPORT"
      ? manifestMovementDirection
      : null;
  const isImportFiling = filingMovementDirection === "IMPORT";
  const isExportFiling = filingMovementDirection === "EXPORT";
  const filingBillNumberValue = isExportFiling
    ? shippingBillNumber
    : billOfEntryNumber;
  ...
  useEffect(() => {
    ...
    if (savedBillNumber) {
      setFilingFieldValues((prev) =>
        prev.bill_number?.trim()
          ? prev
          : { ...prev, bill_number: savedBillNumber },
      );
    }
  }, [activeNodeRun?.id, filingBillNumberValue]);
  const requiresIgm =
    manifestRequirement === "IGM" || manifestRequirement === "BOTH";
  const requiresEgm =
    manifestRequirement === "EGM" || manifestRequirement === "BOTH";
  ...
  const hasPersistedAdditionalData =
    hasManuallySavedAdditionalData || activeStepIndex > 1;
  const canEditAdditionalData =
    canUpdateJob && additionalDataStageAvailable && hasPersistedAdditionalData;
  const additionalDataLocked =
    !additionalDataStageAvailable ||
    !canUpdateJob ||
    (hasPersistedAdditionalData && !isAdditionalDataEditing);

  const addContainerEntry = () => {
    setContainerEntries((current) => [...current, getDefaultContainerEntry()]);
  };

  const updateContainerEntry = (
    index: number,
    field: keyof ContainerEntry,
    value: string,
  ) => {
  ...
  const populatedContainerCount = containerEntries.filter((entry) =>
    entry.containerNumber.trim(),
  ).length;
  ...
  const blPreview =
    mblNumber || hblNumber
      ? [mblNumber && `MBL: ${mblNumber}`, hblNumber && `HBL: ${hblNumber}`]
          .filter(Boolean)
          .join(" / ")
      : "Pending";
  const activeDeletionRequest =
    job.deletionRequests?.find((request: any) =>
  ...
  const pendingDeletionReview =
    job.deletionRequests?.find(
      (request: any) =>
        ...
        request.assignedManagerId === currentUserId,
    ) ?? null;
  ...
  const isAssignedExpenseAccountsUser = job.assignments?.some(
    (assignment: any) =>
      assignment.userId === currentUserId &&
      assignment.responsibility === "ACCOUNTS",
  );
  const canReviewExpenseRequests = Boolean(
    canManageExpenses || isConcernedExpenseManager,
  );
  const canProcessExpensePayments = Boolean(
    canPayExpenses || isAssignedExpenseAccountsUser,
  );
  ...
  const currentChecklistVersion =
    checklistWorkflow?.currentFileVersion ??
    checklistWorkflow?.fileVersions?.[0] ??
    null;

  useEffect(() => {
    if (
      ["docs", "additionalData", "checklist", "filing", "expenses"].includes(
        activeTab,
      )
    ) {
      ...
      else if (activeTab === "additionalData")
        setExpandedStageKey("ADDITIONAL_DATA");
      else if (activeTab === "checklist") {
        setExpandedStageKey("CHECKLIST");
      } else if (activeTab === "filing")
        setExpandedStageKey(job.stage === "FILED" ? "FILED" : "FILING");
    } else {
  ...
  const animateStageScrollIntoView = (stageKey: string, attempt = 0) => {
    const target = document.getElementById(
      `workflow-stage-${stageKey.toLowerCase()}`,
    );
    if (!target) {
      if (attempt < 8) {
        window.setTimeout(
          () => animateStageScrollIntoView(stageKey, attempt + 1),
          70,
        );
      }
      return;
  ...
  const openWorkflowStage = (stageKey: string) => {
    const uiStageKey =
      stageKey === "FILED" || stageKey === "EXPENSES"
        ? stageKey
        : getWorkflowUiStageKey(stageKey);
    const targetTab =
    ...
    stageFocusTimeoutRef.current = window.setTimeout(
  ...
  const latestCustomerMailLog =
    checklistWorkflow?.customerMailLogs?.[0] ?? null;
  ...
  const customerApprovalDelayRemainingMs = customerApprovalVisibleAt
    ...
    : 0;
  const customerApprovalDelayElapsed = customerApprovalVisibleAt
    ? customerApprovalDelayRemainingMs === 0
    : false;
  ...
  const latestCustomerResponse =
    (checklistWorkflow?.customerResponses ?? []).find((response: any) => {
      if (!currentChecklistVersion?.uploadedAt) return true;
      return (
        new Date(response.submittedAt).getTime() >=
        new Date(currentChecklistVersion.uploadedAt).getTime()
      );
    }) ?? null;
  ...
  const approvedInternalDecision =
    currentInternalApprovals.find(
      (approval: any) => approval.action === "APPROVED",
    ) ?? null;
  const approvedCustomerDecision =
    currentCustomerApprovals.find(
      (approval: any) => approval.action === "APPROVED",
    ) ??
    (portalCustomerDecision?.action === "APPROVED"
      ? portalCustomerDecision
      : null);
  const rejectedCustomerDecision =
    currentCustomerApprovals.find(
      (approval: any) => approval.action === "REJECTED",
    ) ??
    (portalCustomerDecision?.action === "REJECTED"
      ? portalCustomerDecision
      : null);
  const finalCustomerDecision =
    approvedCustomerDecision ?? rejectedCustomerDecision;
  ...
  const getCustomerResponseForVersion = (version: any) => {
    ...
    const nextUploadedAt = nextVersion
      ? new Date(nextVersion.uploadedAt).getTime()
  ...
  const getChecklistVersionStatus = (versionId?: string | null) => {
    ...
    const version = checklistWorkflow?.fileVersions?.find(
    ...
    const versionApprovals = checklistApprovals.filter(
      (approval: any) => approval.fileVersionId === versionId,
    );
    ...
    if (
      versionApprovals.some((approval: any) => approval.action === "REJECTED")
    ) {
      return { label: "Rejected", variant: "destructive" as const };
    }
    if (
      versionApprovals.some(
        (approval: any) =>
          approval.stage === "CUSTOMER" && approval.action === "APPROVED",
      )
    ) {
      return { label: "Customer Approved", variant: "success" as const };
    }
    if (
      versionApprovals.some(
        (approval: any) =>
          approval.stage === "INTERNAL" && approval.action === "APPROVED",
      )
    ) {
  ...
  const canCurrentUserInternalApprove =
    canInternalApproveChecklist ||
    currentInternalApprovals.some(
      (approval: any) =>
        approval.assignedToId === currentUserId &&
        approval.action === "PENDING",
    );
  const canCurrentUserCustomerApprove =
    canCustomerApproveChecklist ||
    currentCustomerApprovals.some(
      (approval: any) =>
        approval.assignedToId === currentUserId &&
        approval.action === "PENDING",
    );
  ...
  const getDecisionActorLabel = (decision: any) => {
    if (decision?.portalUser?.name)
      return `${decision.portalUser.name} (Customer Portal)`;
    if (decision?.portalUser?.email)
      return `${decision.portalUser.email} (Customer Portal)`;
    ...
    new Set(
      [
        ...
        ...currentInternalApprovals
          ...
          .map(
            (approval: any) =>
              `${getUserName(approval.assignedToId)} (${getInternalApproverRole(approval)})`,
          ),
      ].filter(Boolean) as string[],
    ),
  );
  const currentUserName =
    users.find((user) => user.id === currentUserId)?.name || "You";
  ...
  const handleUploadDoc = async (
    ...
    const requiresValidity =
      !!requirement?.requirementItem?.requiresValidityDate;
    ...
    try {
      ...
      const res = await actions.uploadDocumentVersionAction(
        job.id,
        reqId,
        formData,
      );
  ...
  const handleAcceptCustomerDocument = async (reqId: string) => {
    ...
    try {
      const res = await actions.acceptCustomerDocumentSubmissionAction(
        job.id,
        reqId,
      );
      if (!res.ok) {
  ...
  const handleCreateCustomDocument = async () => {
    ...
    try {
      ...
      const res = await actions.createJobCustomDocumentUploadAction(
        job.id,
        formData,
      );
      if (res.ok) {
        ...
        const currentVersion =
          createdRequirement?.versions?.find(
            (version: any) => version.isCurrent,
          ) || createdRequirement?.versions?.[0];
        if (currentVersion?.id) {
          setPreviewUrls((prev) => ({
            ...prev,
            [currentVersion.id]: localUrl,
          }));
        }
  ...
  const handleDeclareException = async (reqId: string) => {
    ...
    try {
      const res = await actions.declareDocumentExceptionAction(
        job.id,
        reqId,
        exceptionReason,
      );
  ...
  const handleConfirmMarkAllNotAvailable = async () => {
    ...
    try {
      ...
      for (const requirement of bulkNaEligibleRequirements) {
        const res = await actions.markDocumentNotAvailableAction(
          job.id,
          requirement.id,
        );
        if (res.ok) {
      ...
      if (updatedIds.size > 0) {
        ...
        toast.success(
          `Marked ${updatedIds.size} document requirement(s) as N/A.`,
        );
        refreshJobInBackground();
      }
          ...
          current.map((req) =>
            req.id === reqId
              ? {
                  ...
                  status:
                    res.data?.newStatus ||
                    (req.versions?.length ? "UPLOADED" : "PENDING"),
                  exception: null,
                }
              : req,
          ),
  ...
  const handleProceedStage = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          "Workflow stage advanced to Additional Data successfully.",
        );
        ...
        setProceedErrors(
          res.error
            ? [res.error]
            : ["Mandatory document requirement gating check failed."],
        );
  ...
  const buildAdditionalDataPayload = () => ({
    ...
    importGeneralManifest:
      importGeneralManifest === "" ? null : importGeneralManifest,
    exportGeneralManifest:
      exportGeneralManifest === "" ? null : exportGeneralManifest,
    customManifestValue:
      customManifestValue === "" ? null : customManifestValue,
  ...
  const persistAdditionalData = async ({
    ...
    if (
      importGeneralManifest !== "" &&
      !isValidManifest(importGeneralManifest)
    ) {
      if (!silent) {
    ...
    if (
      exportGeneralManifest !== "" &&
      !isValidManifest(exportGeneralManifest)
    ) {
      if (!silent) {
      ...
      if (res.ok) {
        ...
        if (silent) {
          if (!additionalDataAutosaveErrorShownRef.current) {
            toast.error(
              res.error ||
                "Auto-save failed for Additional Data. Your local draft is still preserved.",
            );
  ...
  const handleProceedAdditionalData = async () => {
    ...
    if (!vesselInwardDate || !deliveryOrderValidity) {
      toast.error(
        "Complete Vessel Inward Date and DO Validity before proceeding.",
      );
      return false;
    }
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          "Additional Data saved and workflow advanced to Checklist Preparation.",
        );
        router.refresh();
        return true;
      } else {
      ...
      if (res.ok) {
        ...
        toast.success(
          currentChecklistVersion
            ? "Checklist reuploaded for approval."
            : "Checklist uploaded for approval.",
        );
  ...
  const handleChecklistInternalDecision = async (
  ...
  const handleChecklistCustomerDecision = async (
    decision: "APPROVED" | "REJECTED",
  ) => {
    if (!checklistWorkflow) return;
      ...
      if (res.ok) {
        toast.success(
          decision === "APPROVED"
            ...
            : "Checklist returned from customer for rework.",
        );
  ...
  const handleSendChecklistCustomerMail = async () => {
    if (!checklistWorkflow) return;
    const subject =
      customerMailSubject.trim() ||
      `Checklist Approval Required - ${job.jobNumber}`;
    const body =
      customerMailBody.trim() ||
      `Please review the attached approved checklist for job ${job.jobNumber}.`;
    ...
    try {
      ...
      customerMailAttachments.forEach((file) =>
        formData.append("customerMailAttachments", file),
      );
      const res = await actions.sendChecklistCustomerMailAction(
        job.id,
        checklistWorkflow.id,
        formData,
      );
      if (res.ok) {
        toast.success(
          "Customer email sent with the approved checklist attached.",
        );
  ...
  const handleSubmitJobDeletion = async () => {
    if (!deleteInputsMatch) {
      toast.error(
        "Enter the exact job number and confirmation phrase to continue.",
      );
      return;
    }
  ...
  const handleApproveDeletionRequest = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(
          `Deletion request approved and job ${job.jobNumber} deleted.`,
        );
        resetDeletionModalState();
        router.push("/cha/jobs");
      } else {
  ...
  const handleMarkAsFiled = async (e: React.FormEvent) => {
    ...
    const est = job.filing.estimatedFilingDate
      ? new Date(job.filing.estimatedFilingDate)
      : null;
    ...
    if (isDelayed && !delayReason.trim()) {
      toast.error(
        "This filing is delayed. A justification reason is mandatory.",
      );
      return;
    }
  ...
  const loadFilingData = async () => {
    ...
    try {
      ...
      if (instanceRes.ok) {
        ...
        const activeRun =
          instanceRes.data?.activeNodeRun ||
          instanceRes.data?.nodeRuns?.find((r: any) => r.status === "ACTIVE");
        setActiveNodeRun(activeRun || null);
        setSelectedJumpBackNodeKey(
          (current) =>
            current || instanceRes.data?.jumpBackTargets?.[0]?.nodeKey || "",
        );
        ...
        if (activeRun) {
          ...
          > = {};
          const activeNodeItemIds = activeRun.node.checklistItems.map(
            (item: any) => item.id,
          );
          const currentResponses =
            instanceRes.data.responses?.filter((r: any) =>
              activeNodeItemIds.includes(r.checklistItemId),
            ) || [];

          activeRun.node.checklistItems.forEach((item: any) => {
            const match = currentResponses.find(
          ...
          setChecklistResponses(
            shouldPreserveDraft
              ? mergeFilingChecklistResponses(
                  initialResponses,
                  currentDraftSnapshot.checklistResponses,
                )
              : initialResponses,
          );
          const fieldValuesForNode = Object.fromEntries(
            (instanceRes.data.fieldValues || [])
              ...
              .map((entry: any) => [
                entry.fieldKey,
                entry.valueJson == null ? "" : String(entry.valueJson),
              ]),
          );
          setFilingFieldValues((current) => {
            ...
            for (const [fieldKey, fieldValue] of Object.entries(
              currentDraftSnapshot.filingFieldValues,
            )) {
          ...
          const toggleStateDetailsForNode = Object.fromEntries(
            toggleEntriesForNode.map((entry: any) => [
              entry.sectionKey,
              {
                ...
                state:
                  entry.stateJson && typeof entry.stateJson === "object"
                    ? entry.stateJson
                    : null,
              },
            ]),
          ...
          const queryProcessingDetails = toggleStateDetailsForNode
            .query_processing?.state as
            Record<string, unknown> | null | undefined;
          const serverQueryReferenceNumber =
            typeof queryProcessingDetails?.queryReferenceNumber === "string"
              ? queryProcessingDetails.queryReferenceNumber
              : "";
          const serverQueryOfficerName =
            typeof queryProcessingDetails?.customsOfficerName === "string"
              ? queryProcessingDetails.customsOfficerName
              : "";
          const serverQueryReceivedAt =
            typeof queryProcessingDetails?.queryReceivedAt === "string"
              ? queryProcessingDetails.queryReceivedAt
              : "";
          const serverQueryTitle =
            typeof fieldValuesForNode.query_title === "string"
              ? fieldValuesForNode.query_title
              : "";
          const serverQueryDetails =
            typeof fieldValuesForNode.query_notes === "string"
              ? fieldValuesForNode.query_notes
              : "";

          setFilingQueryReferenceNumber(
            shouldPreserveDraft &&
              currentDraftSnapshot.filingQueryReferenceNumber.trim()
              ? currentDraftSnapshot.filingQueryReferenceNumber
              : serverQueryReferenceNumber,
          );
          setFilingQueryOfficerName(
            shouldPreserveDraft &&
              currentDraftSnapshot.filingQueryOfficerName.trim()
              ? currentDraftSnapshot.filingQueryOfficerName
              : serverQueryOfficerName,
          );
          setFilingQueryReceivedAt(
            shouldPreserveDraft &&
              currentDraftSnapshot.filingQueryReceivedAt.trim()
          ...
          setFilingQueryDetails(
            shouldPreserveDraft &&
              currentDraftSnapshot.filingQueryDetails.trim()
              ? currentDraftSnapshot.filingQueryDetails
              : serverQueryDetails,
          );
          if (shouldPreserveDraft) {
            setFilingQueryResponderNames(
              currentDraftSnapshot.filingQueryResponderNames,
            );
            setFilingQueryStatusUpdates(
              currentDraftSnapshot.filingQueryStatusUpdates,
            );
          } else {
            setFilingQueryResponderNames({});
            setFilingQueryStatusUpdates({});
          ...
          const outgoing = edges.filter(
            (e: any) => e.sourceKey === activeRun.nodeKey,
          );
          if (outgoing.length === 1) {
            setSelectedNextNodeKey(
              shouldPreserveDraft &&
                currentDraftSnapshot.selectedNextNodeKey.trim()
        ...
        setNodeRemarks(
          activeRun &&
            previousActiveNodeRunId === activeRun.id &&
            currentDraftSnapshot.nodeRemarks.trim()
        ...
        setNodeDelayRemarks(
          activeRun &&
            previousActiveNodeRunId === activeRun.id &&
            currentDraftSnapshot.nodeDelayRemarks.trim()
        ...
        toast.error(
          instanceRes.error ||
            "Failed to load filing workflow. Check that a workflow is published in CHA Settings.",
        );
      }
      if (section49Res.ok) {
  ...
  const persistFilingDraft = async ({
    ...
    const toggleStatesForSave = Object.entries(
      currentDraft.filingToggleStateDetails,
    ...
    const fieldValuesForSave = [
      ...Object.entries(currentDraft.filingFieldValues).map(
    ...
    try {
      const result = await actions.saveFilingNodeDraftAction(
        job.id,
        activeNodeRun.id,
        {
      ...
      if (!result.ok) {
        if (silent) {
          if (!filingAutosaveErrorShownRef.current) {
            toast.error(
              result.error ||
                "Auto-save failed for this filing stage. Your local draft is still preserved.",
            );
  ...
  const showFilingValidationWarning = (warning: FilingValidationWarning) => {
    ...
    window.setTimeout(() => {
      filingActiveNodeCardRef.current?.scrollIntoView({
        behavior: "smooth",
        block: "start",
      });
    }, 80);
  ...
  const handlePersistFilingToggleState = async (
    ...
    try {
      const res = await actions.upsertFilingWorkflowToggleStateAction(
        job.id,
        activeNodeRun.id,
        {
          sectionKey,
  ...
  const completeActiveFilingNode = async () => {
    ...
    const validationWarning: FilingValidationWarning = {
      message:
        "Complete the highlighted required fields before finishing this stage.",
      details: [],
      fieldKeys: [],
      checklistItemIds: [],
    ...
    if (isActiveStageBlocked) {
      showFilingValidationWarning({
        ...validationWarning,
        message:
          "Complete the missing prerequisite stage before continuing this filing stage.",
        details: activeNodePrerequisiteStatus?.missingNodeNames?.length
          ? activeNodePrerequisiteStatus.missingNodeNames.map(
              (name: string) => `Prerequisite stage: ${name}`,
            )
    ...
    if (!isSkippingActiveOptionalNode) {
      if (queryProcessingEnabled && !queryProcessingResolved) {
        addValidationDetail(
          "Resolve query processing before moving to the next filing step.",
        );
      ...
      if (activeNodeRun.node.commentsRequired && !nodeRemarks.trim()) {
        addValidationDetail(
          `Completion comments are required for ${activeNodeRun.node.name}.`,
        );
      ...
      if (activeNodeDelayRemarksRequired && !nodeDelayRemarks.trim()) {
        addValidationDetail(
          "Stage delay remarks are required because this stage crossed its SLA.",
        );
      ...
      for (const section of visibleNodeConditionalSections) {
        ...
        for (const requirement of section.unlocksDocuments ?? []) {
          ...
          if (!activeNodeDocumentAttachmentsByKey.get(requirement.key)) {
            addValidationDetail(
              `${requirement.label || requirement.key} upload is required.`,
            );
        ...
        for (const item of activeChecklistItems) {
          if (item.isMandatory) {
            ...
            if (!resp || !resp.isChecked) {
              addValidationDetail(
                `Mandatory checklist item "${item.label}" must be checked.`,
              );
      ...
      for (const item of activeChecklistItems) {
        ...
        const matchingOverdue = overdueChecklistItems.find(
          (entry: any) => entry.checklistItemId === item.id,
        );
        if (
          matchingOverdue &&
        ...
        const checklistItemAttachments =
          checklistAttachmentsByItem.get(item.id) || [];
        if (
          checklistItemAllowsDirectUpload(item) &&
          (item.minUploads || 0) > 0 &&
          ...
          addValidationDetail(
            `Supporting upload is required for checklist item "${item.label}".`,
          );
          validationWarning.checklistItemIds.push(item.id);
        }
      }
      ...
      for (const pr of activeNodeRun.node.photoRequirements) {
        if (pr.isMandatory) {
          const uploadedCount = currentAttachments.filter(
            (a: any) => a.photoRequirementId === pr.id,
          ).length;
          if (uploadedCount < pr.minPhotos) {
            addValidationDetail(
              `Mandatory upload "${pr.label}" requires at least ${pr.minPhotos} file(s). Uploaded ${uploadedCount}.`,
            );
    ...
    if (validationWarning.details.length > 0) {
      validationWarning.fieldKeys = Array.from(
        new Set(validationWarning.fieldKeys),
      );
      validationWarning.checklistItemIds = Array.from(
        new Set(validationWarning.checklistItemIds),
      );
      validationWarning.checklistRemarkItemIds = Array.from(
        new Set(validationWarning.checklistRemarkItemIds),
      );
      validationWarning.checklistDelayRemarkItemIds = Array.from(
        new Set(validationWarning.checklistDelayRemarkItemIds),
      );
      validationWarning.documentRequirementKeys = Array.from(
        new Set(validationWarning.documentRequirementKeys),
      );
      validationWarning.photoRequirementIds = Array.from(
        new Set(validationWarning.photoRequirementIds),
      );
      validationWarning.miscKeys = Array.from(
        new Set(validationWarning.miscKeys),
      );
    ...
    try {
      ...
      if (hasShipmentBillNumberField && filingFieldValues.bill_number?.trim()) {
        ...
        const shipmentSaveRes = await actions.upsertFilingShipmentDetailsAction(
          job.id,
          {
            filingShipmentType,
        ...
        if (!shipmentSaveRes.ok) {
          toast.error(
            shipmentSaveRes.error || "Failed to save bill number for filing.",
          );
          return false;
        }
      }
      ...
      const responsesList = activeChecklistItems.map((item: any) => {
        const val = checklistResponses[item.id] || {
          isChecked: false,
          remarks: "",
          fileKey: undefined,
          delayRemarks: "",
      ...
      const res = await actions.completeFilingNodeAction(
        job.id,
        activeNodeRun.id,
        {
          remarks: nodeRemarks,
          ...
          fieldValues: Object.entries(filingFieldValues).map(
            ([fieldKey, value]) => ({ fieldKey, value }),
          ),
          toggleStates: Object.entries(filingToggleStateDetails).map(
            ([sectionKey, entry]) => ({
              sectionKey,
              isEnabled: entry.isEnabled,
  ...
  const handleGoBackStage = async () => {
    ...
    if (!selectedJumpBackNodeKey) {
      toast.error(
        goBackMode === "return"
          ? "No return stage is available right now."
          : "Select the filing stage you want to reopen.",
      );
      return;
    }
    if (!goBackReason.trim()) {
      toast.error(
        goBackMode === "return"
          ? "Enter a reason to return to the current stage."
          : "Enter a reason to jump back to the selected filing stage.",
      );
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(
          res.error || "Failed to jump back to the selected filing stage.",
        );
      }
    } catch (err: any) {
      toast.error(err.message || "An unexpected error occurred.");
  ...
  const handleReturnToCurrentStage = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(
          res.error || "Failed to return to the current filing stage.",
        );
      }
    } catch (err: any) {
      toast.error(err.message || "An unexpected error occurred.");
  ...
  const handleRedirectBlockedStage = async (targetNodeKey: string) => {
    ...
    try {
      const res = await actions.redirectBlockedFilingStageAction(
        job.id,
        activeNodeRun.id,
        targetNodeKey,
      );
      if (res.ok) {
        toast.success(
          `Redirected to ${res.data?.redirectedToNodeName || "the prerequisite stage"}.`,
        );
        await loadFilingData();
        router.refresh();
      } else {
        toast.error(
          res.error || "Failed to redirect to the prerequisite stage.",
        );
      }
    } catch (err: any) {
      toast.error(err.message || "An unexpected error occurred.");
  ...
  const handleResumeBlockedStage = async () => {
    ...
    try {
      const res = await actions.resumeBlockedFilingStageAction(
        job.id,
        activeNodeRun.id,
      );
      if (res.ok) {
        toast.success(
          `Resumed ${res.data?.reopenedNodeName || "the blocked stage"}.`,
        );
        await loadFilingData();
        router.refresh();
      } else {
  ...
  const handleUploadFilingPhoto = async (
    photoRequirementId: string | null,
    e: React.ChangeEvent<HTMLInputElement>,
  ) => {
    const file = e.target.files?.[0];
    if (!file || !activeNodeRun) return;
    const requirement = activeNodeRun.node.photoRequirements?.find(
      (entry: any) => entry.id === photoRequirementId,
    );
    const validityDateValue = requirement?.requiresValidity
      ? getUploadValidityDate()
      : "";
    ...
    try {
      ...
      const res = await actions.uploadFilingAttachmentAction(
        job.id,
        activeNodeRun.id,
        photoRequirementId,
        null,
  ...
  const handleDeleteFilingPhoto = async (attachmentId: string) => {
    const attachment = filingInstance?.attachments?.find(
      (entry: any) => entry.id === attachmentId,
    );
    setLoading(`filing-delete-${attachmentId}`);
    try {
      const res = await actions.deleteFilingAttachmentAction(
        job.id,
        attachmentId,
      );
      if (res.ok) {
        if (attachment?.checklistItemId) {
          ...
          attachment?.documentRequirementKey ||
          attachment?.photoRequirementId
        ) {
          markLatestVerifiedChecklistItemForReverification();
        }
  ...
  const handleUpdateFilingAttachmentValidity = async (
    attachmentId: string,
    validityDate: string | null,
  ) => {
    setLoading(`filing-attachment-validity-${attachmentId}`);
    try {
      const res = await actions.updateFilingAttachmentValidityAction(
        job.id,
        attachmentId,
        validityDate,
      );
      if (res.ok) {
        const savedValidityDate = toDateInputValue(
          res.data?.validityDate ?? validityDate,
        );
        ...
        toast.success(
          savedValidityDate
            ? "Validity date updated."
            : "Validity date cleared.",
        );
        await loadFilingData();
        refreshJobInBackground();
      } else {
  ...
  const handleToggleSection49 = async () => {
    ...
    try {
      ...
      const res = await actions.toggleFilingSection49Action(
        job.id,
        nextState,
        section49Remarks,
      );
      if (res.ok) {
        toast.success(
          `Section 49 status updated: ${nextState ? "Enabled" : "Disabled"}`,
        );
        setSection49Remarks("");
  ...
  const handleSaveSection49Validity = async () => {
    ...
    try {
      const res = await actions.updateSection49ValidityAction(
        job.id,
        section49ValidityDate,
      );
      if (res.ok) {
  ...
  const handleUploadChecklistItemFile = async (
    checklistItemId: string,
    e: React.ChangeEvent<HTMLInputElement>,
  ) => {
    const file = e.target.files?.[0];
    if (!file || !activeNodeRun) return;
    const requirement = activeNodeRun.node.checklistItems?.find(
      (entry: any) => entry.id === checklistItemId,
    );
    const validityDateValue = requirement?.requiresValidity
      ? getUploadValidityDate()
      : "";
  ...
  const handleUploadNodeDocument = async (
    ...
    if (!file || !activeNodeRun) return;
    const requirement = [
      ...activeNodeDocumentRequirements,
      ...visibleNodeConditionalSections.flatMap(
        (section: any) => section.unlocksDocuments ?? [],
      ),
  ...
  const handleCreateFilingQuery = async () => {
    ...
    try {
      const res = await actions.createFilingWorkflowQueryAction(
        job.id,
        activeNodeRun.id,
        {
      ...
      if (res.ok) {
        ...
        setFilingFieldValues((current) => ({
          ...current,
          query_notes: filingQueryDetails.trim(),
        }));
        setFilingQueryTitle("");
        setFilingQueryDetails("");
        setFilingQueryReferenceNumber("");
  ...
  const handleUpdateFilingQueryStatus = async (
    ...
    try {
      const res = await actions.updateFilingWorkflowQueryStatusAction(
        job.id,
        queryId,
        {
          status,
      ...
      if (res.ok) {
        const nextState = {
          ...
          latestResponseSubmittedAt:
            status === "REPLIED"
              ? new Date().toISOString()
              : (queryProcessingState?.latestResponseSubmittedAt ?? null),
        } as Record<string, unknown>;
        await handlePersistFilingToggleState(
          "query_processing",
          true,
  ...
  const buildFilingQueryResponseMessage = (
    queryId: string,
    fallbackDetails?: string,
  ) => {
    const response =
      filingQueryStatusUpdates[queryId]?.trim() ||
      fallbackDetails?.trim() ||
      "";
    const responder = (
      filingQueryResponderNames[queryId] || currentUserDisplayName
    ).trim();
    if (!response) {
      return "";
    }
  ...
  const handleAddFilingQueryComment = async (queryId: string) => {
    ...
    try {
      const res = await actions.addFilingWorkflowQueryCommentAction(
        job.id,
        queryId,
        { message },
      );
  ...
  const handleRecordAdvanceReceipt = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await actions.recordCustomerAdvanceReceiptAction(
        job.id,
        job.customerAdvance.id,
        {
          amount: amountNum,
  ...
  const handleCreateExpenseRequest = async (e: React.FormEvent) => {
    ...
    if (expenseUrgent && !expenseUrgencyReason.trim()) {
      toast.error(
        "An urgency explanation is mandatory for immediate disbursements.",
      );
      return;
    }
    ...
    if (lines.some((l) => !l.category || !l.purpose || l.amount <= 0)) {
      toast.error(
        "All lines require a valid category, purpose, and positive amount.",
      );
      return;
    }
    ...
    try {
      ...
      expenseLines.forEach((line, lineIndex) => {
        line.receiptFiles.forEach((file) =>
          formData.append(`receiptAttachment:${lineIndex}`, file),
        );
      });
      const res = await actions.createExpenseRequestWithAttachmentAction(
        job.id,
        formData,
      );
  ...
  const handleEscalateExpense = async () => {
    ...
    try {
      const res = await actions.triggerUrgentExpenseEscalationAction(
        escRequestId,
        escUrgencyReason,
      );
      if (res.ok) {
  ...
  const handleExpenseReview = async (
    ...
    if (
      !requestId ||
      !["CLARIFICATION_REQUIRED", "APPROVED", "REJECTED"].includes(decision)
    )
      return;
    if (
      (decision === "CLARIFICATION_REQUIRED" || decision === "REJECTED") &&
      !remarks.trim()
    ) {
      toast.error(
        "Review remarks explanation is mandatory for rejections or clarifications.",
      );
      return;
    }
  ...
  const handleExpenseClarification = async () => {
    ...
    try {
      const res = await actions.submitExpenseClarificationAction(
        expenseClarificationId,
        expenseClarificationText,
      );
      if (res.ok) {
  ...
  const handleReadyForExpenseDisbursement = async (requestId: string) => {
    ...
    try {
      const res =
        await actions.markExpenseReadyForDisbursementAction(requestId);
      if (res.ok) {
        toast.success("Expense marked ready for disbursement.");
        router.refresh();
      } else {
        toast.error(
          res.error || "Failed to mark expense ready for disbursement.",
        );
      }
    } catch (err: any) {
      toast.error(err.message || "An unexpected error occurred.");
  ...
  const handlePostExpensePayment = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error(
        "All payment disburse fields and payment proof are mandatory.",
      );
      return;
    }
    ...
    try {
      ...
      payProofFiles.forEach((proofFile) =>
        formData.append("paymentProof", proofFile),
      );
      const res = await actions.postExpensePaymentAction(
        payRequestId,
        formData,
      );
  ...
  const handleRaiseQuery = async () => {
    ...
    try {
      const res = await actions.raisePaymentQueryAction(
        queryRequestId,
        queryText,
      );
      if (res.ok) {
  ...
  const handleResolveQuery = async () => {
    ...
    try {
      const res = await actions.resolvePaymentQueryAction(
        resolveQueryId,
        resolutionText,
      );
      if (res.ok) {
  ...
  const docPercentage = useMemo(() => {
    ...
    const uploaded = visibleDocumentRequirements.filter(
      (r: any) =>
        r.status === "UPLOADED" || r.status === "NOT_AVAILABLE" || r.exception,
    ).length;
    return Math.round((uploaded / total) * 100);
  }, [visibleDocumentRequirements, activeStepIndex]);

  const docValidationState = firstUnresolvedMandatoryDocumentId
  ...
  const additionalDataValidationState = additionalDataComplete
    ? "Valid"
    : "Pending Fields";

  const checklistPrepPercentage = currentChecklistVersion ? 100 : 0;
  const checklistPrepValidationState = currentChecklistVersion
    ? "Uploaded"
    : "Awaiting File";
  ...
  const checklistCombinedStatusLabel =
    activeStepIndex > 3
      ? "Approved"
      : isChecklistCustomerReworkRequired
        ? "Customer Rework"
  ...
  useEffect(() => {
    if (
      !finalCustomerDecision?.action ||
      finalCustomerDecision.action === "PENDING"
    )
      return;
    ...
    if (finalCustomerDecision.action === "REJECTED") {
      toast.error(
        `Customer rejected the checklist. Rework upload is required.`,
        {
  ...
  const filingPercentage =
    activeStepIndex > 4 ? 100 : filingInstance?.activeNodeRun ? 50 : 0;
  const filingValidationState = isActiveStageBlocked
    ? "Blocked"
    : activeStepIndex > 4
      ? "Filed"
      : "Active";
  ...
  const stageProgress =
    activeStepIndex >= 5
      ...
      : workflowUiActiveStageIndex >= 0
        ? Math.round(
            ((workflowUiActiveStageIndex + 1) / WORKFLOW_UI_STAGES.length) *
              100,
          )
        : 0;
  ...
  const activeNodeSequence = useMemo(() => {
    ...
    const nodeIndex = filingInstance.version.nodes.findIndex(
      (node: any) => node.key === activeNodeKey,
    );
  ...
  const activeNodeSubtitle = useMemo(() => {
    ...
    if (!node) return null;
    const parts = [node.description, node.sectionName, node.branchName].filter(
  ...
  const filingCompletedSteps = useMemo(
    () =>
      (filingInstance?.nodeRuns || [])
        .filter(
          (run: any) => run.status === "COMPLETED" || run.status === "SKIPPED",
        )
        .sort(
          (left: any, right: any) =>
            new Date(
  ...
  const finalFilingReviewStages = useMemo(() => {
    ...
    const nodeOrder = new Map<string, number>(
      (filingInstance.version?.nodes || []).map((node: any, index: number) => [
        node.key,
        index,
      ]),
    );
    ...
    return (filingInstance.nodeRuns || [])
      ...
      .map((run: any, index: number) => {
        ...
        const completedResponses = responses.filter(
          (response: any) => response.isChecked,
        );
        const attachments = Array.isArray(run.attachments)
          ? run.attachments
          : [];
        const fieldValues = Array.isArray(run.fieldValues)
          ? run.fieldValues
          : [];
        ...
        return {
          ...
          sectionLabel: [run.node?.sectionName, run.node?.branchName]
            .filter(Boolean)
            .join(" / "),
          status: run.status,
          ...
          remarks:
            typeof run.remarks === "string" && run.remarks.trim()
              ? run.remarks.trim()
              : null,
          delayRemarks:
            typeof run.delayRemarks === "string" && run.delayRemarks.trim()
              ? run.delayRemarks.trim()
              : null,
          checklistCompletedCount: completedResponses.length,
          checklistTotalCount:
            responses.length ||
            (run.node?.checklistItems || []).filter(
              (item: any) => item.isActive !== false,
            ).length,
          completedResponses,
          attachments,
    ...
    activeNodeRun?.nodeKey,
    filingInstance?.nodeRuns,
    filingInstance?.responses,
    filingInstance?.version?.nodes,
  ]);
  ...
  const filingBannerStatus = useMemo(() => {
    ...
    if (isActiveStageBlocked) {
      return {
        label: "Blocked",
        description: activeNodePrerequisiteStatus?.missingNodeNames?.length
    ...
    if (latestCompletedRunForActiveNode) {
      const reopenedAt =
        activeNodeRun?.createdAt || activeNodeRun?.updatedAt || null;
      const reopenedAtLabel = reopenedAt
        ? new Date(reopenedAt).toLocaleString("en-IN")
        : null;
      return {
        label: "Reopened Live",
  ...
  const uploadExcludedRequirements = useMemo(
    () =>
      visibleDocumentRequirements.filter(
        (req: any) => req.status === "NOT_AVAILABLE" || !!req.exception,
      ),
    [visibleDocumentRequirements],
  );
  ...
  const uploadedEligibleRequirements = useMemo(
    () =>
      uploadEligibleRequirements.filter(
        (req: any) => req.status === "UPLOADED",
      ),
  ...
  const workflowProgressPercent = useMemo(() => {
    ...
    return Math.round(
      (uploadedEligibleRequirements.length /
        uploadEligibleRequirements.length) *
        100,
    );
  }, [uploadEligibleRequirements.length, uploadedEligibleRequirements.length]);
  const workflowCurrentStepLabel =
    pendingEligibleRequirements.length > 0 ? "Uploads Pending" : "Completed";
  const selectedDocumentPreviewUrl = selectedWorkflowDocumentVersion
    ? previewUrls[selectedWorkflowDocumentVersion.id] ||
      selectedWorkflowDocumentVersion.fileKey ||
      `/api/cha/documents/${selectedWorkflowDocumentVersion.id}`
    : null;
  const selectedDocumentDownloadUrl = selectedWorkflowDocumentVersion
    ...
    : null;
  const deliveryOrderValiditySummary = getValiditySummary(
    deliveryOrderValidity || null,
  );
  const workspaceTabs: { key: WorkspaceTab; label: string; count?: number }[] =
    [
      { key: "overview", label: "Overview" },
      {
        key: "docs",
        label: "Documents",
        count: visibleDocumentRequirements.length,
      },
      ...
      { key: "advances", label: "Advances" },
      {
        key: "expenses",
        label: "Expenses",
        count: job.expenseRequests?.length || 0,
      },
  ...
  const shipmentModeName = String(
    job.shipmentType?.name || job.jobType?.movementDirection || "Clearance",
  );
  const shipmentModeUpper = shipmentModeName.toUpperCase();
  const shipmentModeIcon = shipmentModeUpper.includes("AIR") ? (
    <Plane size={18} />
  ) : shipmentModeUpper.includes("SEA") ? (
    <Ship size={18} />
  ) : (
    <Boxes size={18} />
  );
  const topJobBadges = [
    ...
    ...(job.shipmentType?.name
      ? [{ label: job.shipmentType.name, variant: "secondary" as const }]
      : []),
    ...(job.branch?.name
      ? [{ label: job.branch.name, variant: "secondary" as const }]
      : []),
    {
      label: formatChaBadgeLabel(job.status),
      variant: getChaJobStatusBadgeVariant(job.status),
    },
  ];
  const overviewMetaItems = [
    ...
    },
    {
      ...
      value: job.updatedAt
        ...
        : "Not available",
      secondary: job.updatedAt
        ? new Date(job.updatedAt).toLocaleTimeString("en-IN", {
            hour: "2-digit",
            minute: "2-digit",
          })
        : null,
  ...
  const overviewSummaryItems = [
    {
      label: "Shipment Type",
      value: job.shipmentType?.name || shipmentModeName || "Not set",
      icon: <Package size={14} />,
    },
    {
      label:
        job.shipmentType?.name?.toUpperCase() === "AIR"
          ? "Flight / Voyage"
          : "Vessel / Voyage",
      value: job.flightNumber || job.vesselName || job.carrierName || "Not set",
      icon:
        job.shipmentType?.name?.toUpperCase() === "AIR" ? (
          <Plane size={14} />
        ) : (
    ...
    },
    {
      ...
      value:
        job.portOfDischarge || job.port?.name || job.branch?.name || "Not set",
      icon: <MapPin size={14} />,
    },
    {
    ...
    },
    {
      ...
      value: job.packageCount || job.numberOfPackages || "Not set",
      icon: <Package size={14} />,
      numeric: true,
    },
    {
  ...
  const overviewDateItems = [
    {
      ...
      value: deliveryOrderValidity
        ? new Date(deliveryOrderValidity).toLocaleDateString("en-IN")
        : "Not required",
    ...
    },
    {
      ...
      value: job.ceLabReportValidity
        ? new Date(job.ceLabReportValidity).toLocaleDateString("en-IN")
        : "Not required",
    ...
    },
    {
      ...
      value: job.ewayBillValidity
        ? new Date(job.ewayBillValidity).toLocaleDateString("en-IN")
        : "Not required",
    ...
    },
    {
      ...
      value: job.filing?.estimatedFilingDate
        ? new Date(job.filing.estimatedFilingDate).toLocaleDateString("en-IN")
        : "Pending",
  ...
  const liveStatusLocation =
    job.portOfDischarge ||
    job.port?.name ||
    job.branch?.name ||
    "Tracking location unavailable";
  const liveStatusOrigin =
    job.countryOfOrigin ||
    job.originCountry ||
    job.customer?.branchName ||
    "Origin pending";
  const liveStatusDestination =
    job.portOfDischarge ||
    job.port?.name ||
    job.branch?.name ||
    "Destination pending";
  const overviewWorkflowStages = [
    ...
    ...WORKFLOW_UI_STAGES.map((stage, index) => {
      ...
      const isExpenseCurrent =
        stage.key === "EXPENSES" && activeTab === "expenses";
      return {
        key: stage.key,
        label: stage.label,
        isCompleted:
          ...
          (stage.key !== "EXPENSES" &&
            !isExpenseCurrent &&
            index < workflowUiActiveStageIndex),
  ...
  const workspaceQuickActions = [
    {
      ...
      note: "Add new document",
      icon: <Upload size={16} />,
      onClick: () => navigateToWorkspaceTab("docs"),
      accent: "cyan" as const,
      visible: true,
    },
    {
      label: "Add Query",
      note: "Raise a new query",
      icon: <AlertCircle size={16} />,
      onClick: () => navigateToWorkspaceTab("filing"),
      accent: "orange" as const,
      visible: activeStepIndex >= 4,
    },
    {
      label: "View Workflow",
      note: "See filing workflow",
      icon: <Zap size={16} />,
      onClick: () => navigateToWorkspaceTab("filing"),
      accent: "cyan" as const,
      visible: true,
    ...
    },
    {
      ...
      note: "Raise expense request",
      icon: <CreditCard size={16} />,
      onClick: () => navigateToWorkspaceTab("expenses"),
      accent: "cyan" as const,
      visible: canCreateExpenseRequests,
    },
    {
      label: "Job Activity",
      note: "View all activities",
      icon: <History size={16} />,
      onClick: () => navigateToWorkspaceTab("audit"),
      accent: "cyan" as const,
      visible: true,
    },
    ...
    <main className="mnx-cha-workspace w-full space-y-5 overflow-x-hidden pb-6">
      <div className="space-y-4">
        ...
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, color-mix(in srgb, var(--mnx-surface) 72%, transparent) 0%, color-mix(in srgb, var(--mnx-surface) 72%, transparent) 48%, color-mix(in srgb, var(--mnx-surface) 72%, transparent) 74%, color-mix(in srgb, var(--mnx-surface) 72%, transparent) 100%)",
            }}
          />
            ...
            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
              <div className="min-w-0 space-y-2">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <h1 className="mnx-heading-1 mnx-numeric mnx-text-primary">
                    {job.jobNumber}
                  </h1>
                  <Button
                    type="button"
                ...
                {canDeleteJob ? (
                  <>
                    <Button
                      ...
                      disabled={
                        loading !== null || Boolean(activeDeletionRequest)
                      }
                ...
                {overviewMetaItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1 break-words text-sm font-medium mnx-text-primary">
                        {item.value}
                      </p>
                      {item.secondary ? (
                        <p
        ...
        <section className="mnx-bg-surface mnx-border px-4 py-4">
          <div className="mb-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <p className="mnx-numeric text-sm mnx-text-accent">
                {stageProgress}%
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex min-w-0 flex-1 items-center gap-2">
              <Button
                ...
                onClick={() =>
                  overviewStageScrollerRef.current?.scrollBy({
                    left: -320,
                    behavior: "smooth",
                  })
                }
                      ...
                      >
                        ...
                        <span className="flex items-center gap-1.5">
                          ...
                          {typeof stage.percent === "number" ? (
                            <span className="mnx-numeric text-[10px] mnx-text-accent">
                              {stage.percent}%
                            </span>
                          ) : null}
                        </span>
        ...
        <ChaDueDateWarningNote
          ...
          onAcknowledged={() => {
            setDueDateWarnings((current) =>
              current.filter(
                (entry) => entry.notificationId !== warning.notificationId,
              ),
            );
          }}
        />
      ...
      {filingValidationWarning ? (
        <div className="mnx-bg-surface mnx-border mnx-border-warning rounded-xl border mnx-border-danger mnx-bg-surface p-4 mnx-shadow-panel">
          <div className="flex items-start gap-3">
            <span
              className="mnx-icon-badge animate-pulse-red shrink-0"
              style={{
                background:
                  "color-mix(in srgb, var(--mnx-surface) 72%, transparent)",
            ...
            <div className="min-w-0 space-y-2">
              ...
              <p className="text-sm font-medium mnx-text-primary">
                {filingValidationWarning.message}
              </p>
        ...
        <div className="rounded-2xl border mnx-border-warning mnx-bg-warning p-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div className="space-y-1">
              <span className="mnx-label mnx-text-warning">
                Job Settings Alert
              </span>
              ...
              <p className="text-xs mnx-text-muted">
                An assigned manager is required to proceed with checklist upload
                and approval.
              </p>
            </div>
            {canUpdateJob && (
        ...
        <div className="rounded-2xl border mnx-border-warning mnx-bg-warning p-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs mnx-text-muted">
                Requested by{" "}
                {activeDeletionRequest.requestedBy?.name || "Unknown"} on{" "}
                {new Date(activeDeletionRequest.requestedAt).toLocaleString(
                  "en-IN",
                )}
              </p>
            </div>
      ...
      <div className="space-y-3">
        <aside className="hidden">
          <div className="border-b mnx-border px-2 pb-3">
            ...
            <p className="mt-1 text-xs mnx-text-muted">
              Secondary stage navigator
            </p>
          </div>

          <nav className="space-y-2 pt-3">
            {WORKFLOW_UI_STAGES.map((stage, index) => {
              const isFiledComplete =
                stage.key === "FILED" && activeStepIndex >= 5;
              const isExpenseCurrent =
                stage.key === "EXPENSES" && activeTab === "expenses";
              const isCompleted =
                isFiledComplete ||
                (stage.key !== "EXPENSES" &&
                  ...
                  index < workflowUiActiveStageIndex);
              const isActive =
                isExpenseCurrent || index === workflowUiActiveStageIndex;
              const isLocked =
                stage.key !== "EXPENSES" &&
                !isFiledComplete &&
                index > workflowUiActiveStageIndex;
              ...
              const stageDate = new Date(
                createdDate.getTime() + index * 45 * 60 * 1000,
              );
              const formattedDate =
                stageDate.toLocaleDateString("en-IN", {
                  day: "2-digit",
                  month: "short",
                }) +
                " - " +
                stageDate.toLocaleTimeString("en-US", {
                  hour: "2-digit",
                  minute: "2-digit",
                  hour12: true,
                });
              ...
              return (
                <div key={stage.key} className="relative">
                  <Button
                    ...
                    disabled={isLocked}
                    className={`group relative flex w-full flex-col gap-2 rounded-[var(--mn-radius-control)] p-3 text-left transition-all ${
                      isHighlighted
                  ...
                  >
                    ...
                    <div className="w-full space-y-1 pl-7 text-[10px] mnx-text-muted">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <span
                          className={`inline-block rounded-full px-2 py-1 text-[8px] font-bold uppercase tracking-[0.16em] ${statusBg} ${statusColor}`}
                        >
                          {statusLabel}
                        </span>
                        {!isLocked && (
                          <span className="mnx-numeric font-mono text-[10px] mnx-text-primary font-semibold">
                            {percent}%
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between text-[9px] opacity-80">
                        <span>Owner:</span>
                        <span className="font-medium mnx-text-primary truncate max-w-[100px]">
                          {job.primaryOwner.name}
                        </span>
                      </div>
                  ...
                  {index < WORKFLOW_UI_STAGES.length - 1 && (
                    <div
                      className={`ml-[15px] h-4 w-[2px] rounded-full ${
                        index < workflowUiActiveStageIndex
                          ? "bg-gradient-to-b mnx-bg-success mnx-bg-success"
                          : index === workflowUiActiveStageIndex
                            ? "bg-gradient-to-b mnx-bg-accent-soft mnx-bg-accent-soft"
            ...
            {(
              [
                {
                  key: "advances" as WorkspaceTab,
                  label: "Advances",
                  icon: <CreditCard size={13} />,
                },
                {
                  key: "expenses" as WorkspaceTab,
                  label: "Expenses",
                  icon: <BarChart2 size={13} />,
                  count: job.expenseRequests?.length || 0,
                },
                {
                  key: "audit" as WorkspaceTab,
                  label: "Audit Log",
              ...
              <Button
                ...
                className={`flex w-full items-center gap-2.5 rounded-[var(--mn-radius-control)] px-3 py-2.5 text-left transition-all ${
                  activeTab === item.key
              ...
              >
                ...
                {item.count !== undefined && item.count > 0 && (
                  <span
                    className={`ml-auto rounded-full px-1.5 py-0.5 text-[9px] font-bold mnx-numeric ${
                      activeTab === item.key
                        ? "mnx-bg-accent-soft mnx-text-muted"
                        : "mnx-bg-soft mnx-text-muted"
                    }`}
                  >
                    {item.count}
          ...
          <div className="border-t mnx-border px-4 py-4">
            ...
            <p className="mnx-numeric mt-1 text-3xl font-bold mnx-text-accent">
              {stageProgress}%
            </p>
            ...
            <p className="mt-1.5 text-[10px] mnx-text-muted">
              {workflowUiActiveStageIndex} of {WORKFLOW_UI_STAGES.length} stages
              completed
            </p>
          </div>
        </aside>
        ...
        <div className="min-w-0 space-y-3">
          ...
          {activeTab !== "overview" &&
            ...
            (() => {
              const stageDescriptions: Record<string, string> = {
                ...
                additionalData:
                  "Enter vessel inward date, manifest numbers, delivery order validity, and container details.",
                checklist:
                ...
                expenses:
                  "Submit and manage expense disbursement requests for this job.",
                audit:
                  "View a complete audit trail of all actions and changes made to this job.",
              };
              ...
              const stageTitle =
                workspaceTabs.find((t) => t.key === activeTab)?.label ?? "";
              const stageNum =
                activeTab === "docs"
                  ? 1
                  : activeTab === "additionalData"
                    ...
                    : activeTab === "checklist"
                      ...
                      : activeTab === "filing"
                        ? 4
                        : null;
              const displayTitle = stageNum
                ? `${stageNum}. ${stageTitle}`
                : stageTitle;

              return (
                <div className="rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-surface px-6 py-5 mnx-shadow-panel">
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <span className="flex size-12 items-center justify-center rounded-[var(--mn-radius-control)] bg-gradient-to-br mnx-bg-accent-soft mnx-bg-accent-soft mnx-bg-accent-soft mnx-text-muted mnx-shadow-panel">
                        {stageIcons[activeTab]}
                      </span>
                      <div>
                        <h2 className="mnx-heading-2 mnx-text-primary">
                          {displayTitle}
                        </h2>
                        <p className="mt-1 text-sm leading-relaxed mnx-text-muted">
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        toast.info("Help instructions loading...");
                      }}
                    ...
                    >
                      <HelpCircle
                        size={15}
                        className="rounded-full border mnx-border-accent p-0.5"
                      />
                      Help
                    </a>
                  </div>
            ...
            <div className="space-y-6">
              ...
              {showDocumentCollectionStage ? (
                <MilestoneCard
                  ...
                  assignedUser={
                    job.primaryOwner?.name ||
                    job.assignedManager?.name ||
                    "Operations Team"
                  }
                  dueDate={
                    job.estimatedClosureDate
                      ? new Date(job.estimatedClosureDate).toLocaleDateString(
                          "en-IN",
                        )
                      : null
                  }
                  ...
                  summary={
                    <div className="flex flex-wrap gap-2 text-xs">
                      <span className="mnx-text-muted font-medium">
                        Uploaded:
                      </span>
                      {visibleDocumentRequirements
                      ...
                      {visibleDocumentRequirements.filter(
                        ...
                        <span className="mnx-text-warning font-medium">
                          (
                          {
                            visibleDocumentRequirements.filter(
                              (r: any) =>
                                r.status === "NOT_AVAILABLE" || r.exception,
                            ).length
                          }{" "}
                          exceptions)
                        </span>
                      ...
                      <div className="space-y-5">
                        ...
                        <div className="flex flex-wrap items-center justify-end gap-3">
                          <Button
                            ...
                            disabled={
                              loading !== null ||
                              bulkNaEligibleRequirements.length === 0
                            }
                          ...
                          {sortedUploadedWorkflowDocuments.length > 0 ? (
                            sortedUploadedWorkflowDocuments.map((req: any) => {
                              ...
                              const customerSubmission =
                                req.customerSubmission ?? null;
                              const usesCustomerSubmission = Boolean(
                                req.usesCustomerSubmission &&
                                customerSubmission,
                              );
                              const canAcceptCustomerSubmission =
                                ...
                                [
                                  ...
                                  "CLARIFICATION_REQUIRED",
                                  "REUPLOAD_REQUIRED",
                                ].includes(customerSubmission.status);
                              ...
                              return (
                                ...
                                >
                                  <UploadedWorkflowDocumentCard
                                    ...
                                    selected={
                                      selectedDocumentRequirementId === req.id
                                    }
                                    ...
                                    helperContent={
                                      usesCustomerSubmission ? (
                                        <div className="space-y-2">
                                          ...
                                          <p className="text-sm font-semibold mnx-text-primary">
                                            Customer-uploaded file awaiting CHA
                                            decision
                                          </p>
                                          <p className="text-xs mnx-text-muted">
                                            Accept this file to save it as the
                                            submitted CHA document, or upload
                                            the CHA copy yourself if you need to
                                            replace it.
                                          </p>
                                    ...
                                    footerActions={
                                      canAcceptCustomerSubmission ? (
                                        <Button
                                          ...
                                          disabled={loading !== null}
                                          onClick={() =>
                                            handleAcceptCustomerDocument(req.id)
                                          }
                                        >
                                          <CheckCircle2 size={14} />
                                          {loading ===
                                          `customer-accept-${req.id}`
                                            ? "Accepting..."
                            ...
                            <div className="xl:col-span-2 flex items-center justify-center gap-3 rounded-xl border border-dashed mnx-border mnx-bg-surface p-8 text-center text-sm mnx-text-muted mnx-shadow-panel">
                              <Search
                                size={18}
                                className="shrink-0 mnx-text-accent"
                              />
                              <span>
                                No uploaded documents match the current search
                                and filter state yet.
                              </span>
                            </div>
                          )}
                        </div>
                        ...
                        {section49Requirement ? (
                          <div className="rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-surface p-5 mnx-shadow-panel">
                            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                              <div>
                                <p className="mnx-label mnx-text-accent">
                                  Section 49 Controls
                                </p>
                                <div className="mt-2 grid grid-cols-[4px_minmax(0,1fr)] items-center gap-4">
                                  ...
                                  <h3 className="mnx-heading-3 mnx-text-primary">
                                    Manage Section 49 validity and extension
                                    workflow
                                  </h3>
                                </div>
                                <p className="mt-1 text-sm mnx-text-muted">
                                  Keep the saved validity date current and
                                  attach extension evidence when customs warns
                                  of expiry.
                                </p>
                              </div>
                            ...
                            <div className="mt-4 space-y-4">
                              {section49Flag?.validityDate ? (
                                <div className="flex flex-wrap items-center justify-between gap-3 rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-soft px-4 py-3">
                                  <div>
                                    <p className="mnx-label">
                                      Saved Section 49 Validity
                                    </p>
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      setUploadDocumentModalReqId(
                                        section49Requirement.id,
                                      )
                                    }
                                    disabled={loading !== null}
                                  >
                                ...
                                <div className="grid gap-3 rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-soft p-4 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
                                  <label className="space-y-1">
                                    <span className="mnx-label">
                                      Section 49 Validity Date
                                    </span>
                                    <DateInput
                                      value={section49ValidityDate}
                                      onChange={(e) =>
                                        setSection49ValidityDate(e.target.value)
                                      }
                                      disabled={
                                        loading !== null || !canUpdateJob
                                      }
                              ...
                              {section49Flag?.validityDate ? (
                                <div className="space-y-3 rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-soft p-4">
                                  ...
                                  {Array.isArray(job.section49Extensions) &&
                                  job.section49Extensions.length > 0 ? (
                                    <div className="space-y-2 border-t mnx-border pt-3">
                                      <p className="mnx-label">
                                        Extension History
                                      </p>
                                      {job.section49Extensions
                                        .slice(0, 3)
                                        .map((extension: any) => (
                                          <div
                                            key={extension.id}
                                            className="flex flex-wrap items-center justify-between gap-2 text-sm mnx-text-muted"
                                          >
                                            <span className="mnx-numeric">
                                              {new Date(
                          ...
                          <div className="rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-surface p-5 mnx-shadow-panel">
                            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                              <div>
                                ...
                                <div className="mt-2 grid grid-cols-[4px_minmax(0,1fr)] items-center gap-3">
                                  ...
                                  />
                                  <h3 className="mnx-heading-3 mnx-text-primary">
                                    {activeExceptionRequirement.name}
                                  </h3>
                                </div>
                                <p className="mt-1 text-sm mnx-text-muted">
                                  Record the business reason for handling this
                                  requirement without a file upload.
                                </p>
                              </div>
                            ...
                            <div className="mt-4 space-y-3">
                              <Textarea
                                ...
                                className="min-h-28 w-full rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-surface px-4 py-3 text-sm mnx-text-primary"
                              />
                              <div className="flex flex-wrap justify-end gap-3">
                                ...
                                <Button
                                  type="button"
                                  onClick={() =>
                                    handleDeclareException(
                                      activeExceptionRequirement.id,
                                    )
                                  }
                                >
                                  Save Exemption
                        ...
                        <div className="space-y-4">
                          {groupedPendingWorkflowDocuments.length > 0 ? (
                            groupedPendingWorkflowDocuments.map((group) => (
                              ...
                              >
                                <div className="grid grid-cols-[4px_minmax(0,1fr)] items-start gap-3">
                                  <span
                                    className="mt-0.5 h-7 w-1 rounded-sm mnx-bg-accent-soft"
                                    aria-hidden="true"
                                  />
                                  <div className="min-w-0 space-y-1">
                                    <p className="mnx-heading-3 mnx-text-primary">
                                      {group.categoryName}
                                    </p>
                                    <p className="text-sm mnx-text-muted">
                                      ...
                                      {group.requirements.length === 1
                                        ? ""
                                        : "s"}{" "}
                                      pending action in this category.
                                    </p>
                                  </div>
                                </div>
                                <div className="grid gap-4 xl:grid-cols-2">
                            ...
                            <div className="rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-surface p-8 text-center text-sm mnx-text-muted mnx-shadow-panel">
                              No pending or exception-based requirements match
                              the current filter.
                            </div>
                          )}
                        </div>
                        ...
                        {job.stage === "DOCUMENT_COLLECTION" && (
                          <div className="flex flex-col gap-3 border-t mnx-border pt-4 sm:items-end">
                            {proceedErrors ? (
                              <div className="w-full rounded-[var(--mn-radius-panel)] border mnx-border-warning mnx-bg-warning p-4 text-xs mnx-text-warning sm:max-w-xl">
                                <p className="mnx-label mb-1 mnx-text-warning">
                                  Proceed Blocked
                                </p>
                                <p>{proceedErrors[0]}</p>
                              </div>
                            ...
                            <div className="w-full">
                              <SlideToComplete
                                ...
                                disabled={
                                  loading !== null ||
                                  !!firstUnresolvedMandatoryDocumentId
                                }
                                text={
                                  loading === "proceed-stage"
                                    ? "Advancing stage..."
              ...
              {showAdditionalDataStage ? (
                <MilestoneCard
                  ...
                  dueDate={
                    deliveryOrderValidity
                      ? new Date(deliveryOrderValidity).toLocaleDateString(
                          "en-IN",
                        )
                      : null
                  }
                  completedAt={
                    activeStepIndex > 1
                      ? job.additionalData?.updatedAt
                        ? new Date(job.additionalData.updatedAt).toLocaleString(
                            "en-IN",
                          )
                        : null
                      : null
                  ...
                  summary={
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
                      <div>
                        <span className="mnx-text-muted block text-[10px] uppercase">
                          Vessel Inward Date
                        </span>
                        <span className="font-semibold mnx-text-primary mnx-numeric">
                          {vesselInwardDate
                            ? new Date(vesselInwardDate).toLocaleDateString(
                                "en-IN",
                              )
                            : "-"}
                        </span>
                      ...
                      {requiresIgm && (
                        <div>
                          ...
                          <span className="font-semibold mnx-text-primary font-mono">
                            {importGeneralManifest || "-"}
                          </span>
                        </div>
                      )}
                  ...
                  <div className="space-y-4">
                    {job.stage === "DOCUMENT_COLLECTION" ? (
                      <div className="flex items-start gap-3 rounded-2xl border mnx-border-warning mnx-bg-surface p-4">
                        <AlertTriangle
                          size={22}
                          className="mt-0.5 shrink-0 mnx-text-warning"
                        />
                        <div>
                          <h4 className="text-sm font-bold uppercase tracking-wide mnx-text-warning">
                            DOCUMENT GATE REQUIRED
                          </h4>
                          <p className="mt-1 text-xs leading-relaxed mnx-text-muted">
                            Complete Document Collection before saving or
                    ...
                    {manifestConfigMissing ? (
                      <div className="flex items-start gap-3 rounded-2xl border mnx-border-warning mnx-bg-surface p-4">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-xs leading-relaxed mnx-text-muted">
                            This clearance type is missing manifest
                            configuration. Please update it in CHA settings
                            before continuing.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-6">
                      <AdditionalDataStatCard
                        label="Status"
                        value={job.additionalData?.status ?? "PENDING"}
                      />
                      <AdditionalDataStatCard
                        label="Last Updated"
                        value={
                      ...
                      <AdditionalDataStatCard
                        label="Direction"
                        value={manifestMovementDirection || "Not Configured"}
                      />
                      <AdditionalDataStatCard label="BL No" value={blPreview} />
                      <AdditionalDataStatCard
                        label="Containers"
                        value={String(populatedContainerCount)}
                        numeric
                      />
                    </div>
                          ...
                          <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-12">
                            <label className="space-y-1.5 xl:col-span-4">
                              ...
                              <DateInput
                                ...
                                onChange={(e) =>
                                  setVesselInwardDate(e.target.value)
                                }
                                disabled={
                                  job.stage === "DOCUMENT_COLLECTION" ||
                                  additionalDataLocked
                            ...
                            <label className="space-y-1.5 xl:col-span-4">
                              ...
                              <DateInput
                                ...
                                value={deliveryOrderValidity}
                                onChange={(e) =>
                                  setDeliveryOrderValidity(e.target.value)
                                }
                                disabled={
                                  job.stage === "DOCUMENT_COLLECTION" ||
                                  additionalDataLocked
                            ...
                            {requiresCustomManifest ? (
                              <label className="space-y-1.5 xl:col-span-4">
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    setCustomManifestValue(e.target.value)
                                  }
                                  disabled={
                                    job.stage === "DOCUMENT_COLLECTION" ||
                                    additionalDataLocked ||
                            ...
                            <div className="mt-4 pt-4">
                              <DoValidityPanel
                                ...
                                additionalData={{
                                  ...
                                  doDocumentFileKey:
                                    job.additionalData.doDocumentFileKey ??
                                    null,
                                  doDocumentFileName:
                                    job.additionalData.doDocumentFileName ??
                                    null,
                                  doDocumentUploadedAt:
                                    job.additionalData.doDocumentUploadedAt ??
                                    null,
                                }}
                        ...
                        <div className="mnx-bg-surface mnx-border mnx-bg-surface mnx-border mnx-border-accent rounded-xl border mnx-border mnx-bg-surface p-4 shadow-sm">
                          ...
                          <div className="mt-4 grid grid-cols-1 gap-3">
                            {containerEntries.map((entry, index) => (
                              <div
                                key={`container-${index}`}
                                className="grid grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_64px] md:items-end"
                              >
                                <label className="space-y-1.5">
                                  <span className="mnx-label">
                                    Container {index + 1}
                    ...
                    <div
                      className={`grid gap-3 pt-4 lg:items-center ${
                      ...
                      {job.stage === "ADDITIONAL_DATA" ? (
                        <div className="w-full">
                          <SlideToComplete
                            ...
                            text={
                              loading === "additional-data-proceed"
                                ? "Saving and Proceeding..."
                                : "Slide to complete Additional Data"
                            }
                        ...
                        <div className="flex justify-end">
                          {canEditAdditionalData && additionalDataLocked ? (
                            <Button
                              ...
                              variant="outline"
                              disabled={
                                loading !== null || isAdditionalDataEditing
                              }
              ...
              {showChecklistPreparationStage ? (
                <MilestoneCard
                  ...
                  assignedUser={
                    currentChecklistVersion
                      ? job.assignedManager?.name || "Approval Team"
                      : undefined
                  }
                  dueDate={
                    currentChecklistVersion
                      ? customerApprovalVisibleAt
                        ? customerApprovalVisibleAt.toLocaleString("en-IN")
                        : job.estimatedClosureDate
                          ? new Date(
                              job.estimatedClosureDate,
                            ).toLocaleDateString("en-IN")
                  ...
                  completedAt={
                    activeStepIndex > 3
                      ? approvedCustomerDecision?.actedAt
                        ? new Date(
                            approvedCustomerDecision.actedAt,
                  ...
                  summary={
                    <div className="grid gap-3 text-xs sm:grid-cols-3">
                      <div className="sm:col-span-2">
                        ...
                        {currentChecklistVersion ? (
                          <span className="font-mono font-semibold mnx-text-primary">
                            {currentChecklistVersion.originalFileName} (V
                            {currentChecklistVersion.versionNumber})
                          </span>
                        ) : (
                          <span className="italic mnx-text-danger">
                            No checklist uploaded yet
                          </span>
                        )}
                      </div>
                      <div className="flex gap-4 sm:justify-end">
                        ...
                        >
                          Internal:{" "}
                          {approvedInternalDecision ? "Approved" : "Pending"}
                        </span>
                        <span
                          className={
                            approvedCustomerDecision
                  ...
                  <div className="space-y-5">
                    {!job.assignedManagerId && (
                      <div className="mnx-bg-surface border mnx-border-warning p-4 rounded-2xl flex items-start gap-3">
                        <AlertTriangle
                          size={24}
                          className="mnx-text-warning shrink-0 mt-0.5"
                        />
                        <div>
                          <h4 className="font-bold text-sm uppercase mnx-text-warning">
                            Manager Assignment Recommended
                          </h4>
                          <p className="text-xs mnx-text-muted mt-1 leading-relaxed">
                            No manager has been assigned to this job yet.
                            Internal approval can still be completed by the job
                            owner, or route through the owner&apos;s Manager or
                            TL if configured in HRMS, but assigning a manager
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs mnx-text-muted">
                          Any file format is allowed here. The uploaded file
                          will move into internal approval automatically.
                        </p>
                        ...
                        {isChecklistCustomerReworkRequired ? (
                          <div className="mnx-bg-surface mnx-border mnx-border-warning rounded-xl border mnx-border-danger mnx-bg-danger p-4">
                            <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                              <div className="space-y-1">
                                <p className="text-sm font-medium mnx-text-primary">
                                  Customer rejected the latest checklist.
                                </p>
                                <p className="text-xs mnx-text-muted">
                                  Upload a reworked checklist file here. The
                                  replacement will restart internal approval and
                                  will move directly to Filing after employee
                                  approval.
                                </p>
                        ...
                        <FileUploadField
                          ...
                          onInputChange={(e) =>
                            handleUploadChecklist(e.target.files?.[0] || null)
                          }
                        />
                        <Textarea
                          rows={2}
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="overflow-hidden rounded-xl border mnx-border">
                            <ChaTable className="mnx-cha-table">
                              ...
                              <tbody>
                                {checklistWorkflow?.fileVersions?.map(
                                  (version: any) => {
                                    const versionStatus =
                                      getChecklistVersionStatus(version.id);
                                    return (
                                      <tr key={version.id}>
                                        ...
                                        <td className="text-xs mnx-text-primary">
                                          {getUserName(version.uploadedById)}
                                        </td>
                              ...
                              <>
                                <p className="text-xs mnx-text-muted">
                                  ...
                                  <span className="mnx-text-primary">
                                    {eligibleInternalApproverLabels.join(
                                      ", ",
                                    ) || "Owner, Manager, or TL"}
                                  </span>
                                </p>
                                {checklistWorkflow?.currentApprovalStage ===
                                  "INTERNAL" && !approvedInternalDecision ? (
                                  <p className="text-xs mnx-text-muted">
                                    Pending:{" "}
                                    <span className="mnx-text-primary">
                                      {Array.from(
                        ...
                        checklistWorkflow?.currentApprovalStage ===
                          ...
                          <>
                            <Textarea
                              ...
                              onChange={(e) =>
                                setInternalApprovalRemarks(e.target.value)
                              }
                            ...
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                disabled={loading !== null}
                                onClick={() =>
                                  handleChecklistInternalDecision("REJECTED")
                                }
                              >
                                Reject
                              </Button>
                              <Button
                                ...
                                disabled={loading !== null}
                                onClick={() =>
                                  handleChecklistInternalDecision("APPROVED")
                                }
                              >
                                Approve
                              </Button>
                      ...
                      <div className="mnx-bg-surface mnx-border rounded-xl border mnx-border mnx-bg-surface p-4 space-y-4 shadow-sm">
                        <div className="space-y-3">
                          ...
                          <p className="text-sm mnx-text-primary">
                            {rejectedCustomerDecision
                              ...
                              : approvedCustomerDecision
                                ...
                                : checklistWorkflow?.currentApprovalStage ===
                                      "CUSTOMER" && !latestCustomerMailLog
                          ...
                          {latestCustomerMailLog ? (
                            <p className="text-xs mnx-text-muted">
                              Mail recipients:{" "}
                              {(latestCustomerMailLog.recipients || []).join(
                                ", ",
                              )}
                              . Attachment:{" "}
                              {latestCustomerMailLog.attachmentFileName ||
                                currentChecklistVersion?.originalFileName ||
                                "Checklist file"}
                              .
                            </p>
                          ) : null}
                          ...
                          {checklistWorkflow?.currentApprovalStage ===
                            "CUSTOMER" && !approvedCustomerDecision ? (
                            <p className="text-xs mnx-text-muted">
                              Eligible approvers: any concerned user linked to
                              this job, including the job owner.
                              {pendingCustomerApproverNames.length > 0
                                ? ` Current linked users: ${pendingCustomerApproverNames.join(", ")}`
                                : ""}
                            </p>
                          ) : null}
                        </div>
                          ...
                          <div className="space-y-3">
                            <div className="space-y-1.5">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setCustomerMailSubject(e.target.value)
                                }
                            ...
                            <FileUploadField
                              ...
                              selectedFiles={customerMailAttachments.map(
                                (file) => ({
                                  file,
                                  name: file.name,
                                  sizeBytes: file.size,
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                              <p className="max-w-xl text-xs mnx-text-muted">
                                The latest approved checklist file will be
                                attached automatically, customer recipients will
                                be fetched from the customer record, and any
                                files above will be included after you send the
                                mail.
                              </p>
                              <Button
                                type="button"
                              ...
                              >
                                <Mail size={14} />
                                {loading === "checklist-customer-mail"
                                  ? "Sending..."
                                  : "Send Mail"}
                              </Button>
                            </div>
                        ...
                        customerApprovalDelayElapsed ? (
                          <>
                            <Textarea
                              ...
                              onChange={(e) =>
                                setCustomerApprovalRemarks(e.target.value)
                              }
                              placeholder="Required for rejection, optional for approval"
                              className="mnx-field-textarea w-full"
                            />
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                disabled={loading !== null}
                                onClick={() =>
                                  handleChecklistCustomerDecision("REJECTED")
                                }
                              >
                                Reject
                              </Button>
                              <Button
                                ...
                                disabled={loading !== null}
                                onClick={() =>
                                  handleChecklistCustomerDecision("APPROVED")
                                }
                              >
                                          ...
                                          <p className="text-xs mnx-text-muted">
                                            ...
                                            "CUSTOMER_PORTAL" ? (
                                              ...
                                              <>
                                                ...
                                                {approval.actedById
                                                  ? ` - acted by ${getUserName(approval.actedById)}`
                                                  : ""}
                                              </>
                                            )}
                                          </p>
              ...
              {showFilingStage ? (
                <MilestoneCard
                  ...
                  completedAt={
                    activeStepIndex > 4
                      ? job.filing?.updatedAt
                        ? new Date(job.filing.updatedAt).toLocaleString("en-IN")
                        : null
                      : null
                  }
                  summary={
                    ...
                    {overdueChecklistCount > 0 && (
                      <div className="mnx-bg-surface mnx-border mnx-border-warning rounded-xl border mnx-border mnx-bg-surface p-4 shadow-sm">
                        <div className="flex items-start gap-3">
                          ...
                          />
                          <div className="space-y-1">
                            <h4 className="mnx-label mnx-text-warning">
                              Overdue Filing Checklist Items
                            </h4>
                            <p className="text-sm mnx-text-primary">
                              {overdueChecklistCount} Filing checklist item
                              {overdueChecklistCount > 1 ? "s are" : " is"}{" "}
                              overdue.
                            </p>
                            <p className="text-xs mnx-text-muted">
                              Delay remarks are required before overdue items
                              can be completed.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm mnx-text-muted leading-relaxed">
                              Clearance files can only be submitted to customs
                              after the checklist is approved. Complete all
                              prior checklist preparation and approvals.
                            </p>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="mnx-bg-surface mnx-border mnx-border-accent rounded-xl border mnx-border mnx-bg-surface p-5 shadow-sm">
                            ...
                            {loading === "filing-load" ? (
                              <p className="mt-4 text-xs mnx-text-muted">
                                Loading filing workflow...
                              </p>
                            ) : (
                              <div className="mt-4 space-y-4">
                                <p className="max-w-3xl text-sm mnx-text-muted leading-relaxed">
                                  No active filing workflow instance found.
                                  Ensure a workflow is published in{" "}
                                  <a
                                    href="/cha/settings/filing-workflows"
                                    className="mnx-text-accent underline underline-offset-2"
                                  >
                          ...
                          <div className="space-y-4">
                            {activeNodeRun ? (
                              <div className="space-y-4">
                                ...
                                >
                                  <div
                                    ref={filingActiveNodeCardRef}
                                    className={`mnx-bg-surface mnx-border mnx-border-accent ${filingPrimaryColumnClass} space-y-3 rounded-xl border mnx-border mnx-bg-surface p-4 shadow-sm`}
                                  >
                                    <SectionHeading
                                      index="07"
                                      ...
                                      aside={
                                        <InfoNoteToggle
                                          ...
                                          open={
                                            openWarningNote === "bill-filing"
                                          }
                                          onToggle={() =>
                                            setOpenWarningNote((current) =>
                                              current === "bill-filing"
                                                ? null
                                                : "bill-filing",
                                            )
                                      ...
                                      <div className="mnx-bg-surface mnx-border mnx-border-warning rounded-xl border mnx-border-warning mnx-bg-surface px-4 py-4 space-y-3">
                                        <div className="space-y-1">
                                          ...
                                          <p className="text-sm mnx-text-primary">
                                            ...
                                            {activeNodePrerequisiteStatus?.mode ===
                                            "ANY"
                                              ? "one of these stages is completed"
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                          {(
                                            ...
                                            <Button
                                              ...
                                              disabled={loading !== null}
                                              onClick={() =>
                                                void handleRedirectBlockedStage(
                                                  nodeKey,
                                                )
                                              }
                                            >
                                      ...
                                      <div className="rounded-xl border mnx-border-accent mnx-bg-soft px-4 py-3">
                                        <div className="flex flex-wrap items-center justify-between gap-3">
                                          <div className="space-y-1">
                                            ...
                                            <p className="text-sm mnx-text-primary">
                                              {pendingBlockedStage.nodeName} can
                                              now be resumed.
                                            </p>
                                          </div>
                                          <Button
                                            ...
                                            disabled={loading !== null}
                                            onClick={() =>
                                              void handleResumeBlockedStage()
                                            }
                                          >
                                            Resume{" "}
                                            {pendingBlockedStage.nodeName}
                                          </Button>
                                        </div>
                                      </div>
                                    ) : null}
                                    <div
                                      className={`space-y-3 ${isActiveStageBlocked ? "pointer-events-none opacity-60" : ""}`}
                                    >
                                      {activeNodeRun.node.nodeType ===
                                        "DECISION" &&
                                      outgoingEdges.length > 0 ? (
                                        <div className="space-y-2">
                                          <label className="mnx-label mnx-text-primary block">
                                            Decision *
                                          </label>
                                      ...
                                      {isFinalFilingNode ? (
                                        <div className="space-y-3 mnx-bg-surface p-4 transition-all">
                                          <div className="flex items-start gap-3">
                                            ...
                                            <div className="min-w-0 space-y-1">
                                              <h4 className="mnx-heading-3 mnx-text-primary">
                                                Final Filing Closure
                                              </h4>
                                              <p className="text-sm leading-5 mnx-text-muted">
                                                Review every completed filing
                                                stage before submitting this
                                                final step. Submitting this
                                                stage will close the filing
                                                workflow, record the audit
                                                event, and move the job to
                                                FILED.
                                              </p>
                                            </div>
                                          </div>
                                          ...
                                          <div className="space-y-3 rounded-xl border mnx-border mnx-bg-soft p-3">
                                            <div className="flex flex-wrap items-center justify-between gap-3">
                                              <div className="space-y-1">
                                                <p className="mnx-label mnx-text-muted">
                                                  Completed Stage Overview
                                                </p>
                                                <p className="text-sm mnx-text-primary">
                                                  {
                                                    finalFilingReviewStages.length
                                                  }{" "}
                                                  stage
                                                  {finalFilingReviewStages.length ===
                                                  1
                                              ...
                                              <div className="flex flex-wrap gap-2">
                                                <Badge variant="secondary">
                                                  {finalFilingReviewStages.reduce(
                                                    (
                                                      total: number,
                                                      stage: any,
                                                    ) =>
                                                ...
                                                <Badge
                                                  variant={
                                                    finalFilingReviewStages.some(
                                                      (stage: any) =>
                                                        stage.openQueryCount >
                                                        0,
                                                    )
                                                      ? "warning"
                                                      : "success"
                                            ...
                                            0 ? (
                                                    ...
                                                    >
                                                      <summary className="flex cursor-pointer list-none items-start justify-between gap-3 px-3 py-3 mnx-hover-accent">
                                                        <div className="flex min-w-0 items-start gap-3">
                                                          <span className="flex size-9 shrink-0 items-center justify-center rounded-xl border mnx-border-accent mnx-bg-accent-soft mnx-text-accent">
                                                            <span className="mnx-numeric text-xs">
                                                              {String(
                                                                stage.sequence,
                                                              ).padStart(
                                                                2,
                                                          ...
                                                          <div className="min-w-0 space-y-1">
                                                            <div className="flex flex-wrap items-center gap-2">
                                                              <h5 className="truncate text-sm font-medium mnx-text-primary">
                                                                {stage.nodeName}
                                                              </h5>
                                                              <Badge
                                                                variant={
                                                            ...
                                                            <p className="text-xs mnx-text-muted">
                                                              {stage.completedAt
                                                                ? `Completed ${new Date(stage.completedAt).toLocaleString("en-IN")}`
                                                                : "Completion time not recorded"}
                                                              {stage.completedByName
                                                                ? ` by ${stage.completedByName}`
                                                                : ""}
                                                            </p>
                                                          </div>
                                                        </div>
                                                      ...
                                                      <div className="space-y-3 border-t mnx-border px-3 py-3">
                                                        <div className="grid gap-2 sm:grid-cols-3">
                                                          <div className="rounded-xl border mnx-border mnx-bg-soft px-3 py-2">
                                                            ...
                                                            <p className="mnx-numeric mt-1 text-sm mnx-text-primary">
                                                              {
                                                                stage.checklistCompletedCount
                                                              }
                                                              /
                                                          ...
                                                          <div className="space-y-2">
                                                            {stage.remarks ? (
                                                              <div className="rounded-xl border mnx-border mnx-bg-soft px-3 py-2">
                                                                ...
                                                                <p className="mt-1 text-sm leading-5 mnx-text-primary">
                                                                  {
                                                                    stage.remarks
                                                                  }
                                                                </p>
                                                                ...
                                                                .map(
                                                                  (
                                                                    ...
                                                                    <div
                                                                      ...
                                                                      className="rounded-xl border mnx-border mnx-bg-soft px-3 py-2"
                                                                    >
                                                                      <div className="flex items-start gap-2">
                                                                        <CheckCircle2
                                                                          ...
                                                                          className="mt-0.5 shrink-0 mnx-text-accent"
                                                                        />
                                                                        <div className="min-w-0">
                                                                          ...
                                                                          {response.remarks ? (
                                                                            <p className="mt-1 text-xs leading-4 mnx-text-muted">
                                                                              {
                                                                                response.remarks
                                                                              }
                                                                            </p>
                                              ...
                                              <div className="rounded-xl border border-dashed mnx-border px-4 py-5 text-sm mnx-text-muted">
                                                No completed filing stages are
                                                available yet.
                                              </div>
                                            )}
                                          </div>
                                      ...
                                      activeNodeDocumentRequirements.length >
                                        ...
                                        <div className="space-y-3 pt-1">
                                          {activeNodeFieldDefinitions.length >
                                          0 ? (
                                            <div className="grid grid-cols-1 gap-2.5 md:grid-cols-2">
                                              {activeNodeFieldDefinitions.map(
                                                (field: any) => {
                                                  const isMissingField =
                                                    filingValidationWarning?.fieldKeys.includes(
                                                      field.key,
                                                    ) &&
                                                    !String(
                                                      filingFieldValues[
                                          ...
                                          {activeChecklistItems.length === 0 &&
                                            activeNodeDocumentRequirements.length >
                                              0 &&
                                            (() => {
                                              const requiredDocumentTotal =
                                                activeNodeDocumentRequirements.filter(
                                                  (requirement: any) =>
                                                    requirement.required !==
                                                    false,
                                                ).length;
                                              const requiredDocumentUploadedCount =
                                                activeNodeDocumentRequirements.filter(
                                                  (requirement: any) =>
                                                    requirement.required !==
                                                      false &&
                                                    !!activeNodeDocumentAttachmentsByKey.get(
                                                      requirement.key,
                                                    ),
                                                ).length;
                                              const isCompleted =
                                                requiredDocumentUploadedCount >=
                                                requiredDocumentTotal;
                                              const hasMissingStandaloneDocuments =
                                              ...
                                              return (
                                                <div className="space-y-3 pt-3 border-t mnx-border mt-3">
                                                  <h4 className="mnx-label mnx-text-primary">
                                                  ...
                                                  >
                                                    <div
                                                      className={`pointer-events-none absolute inset-y-4 left-0 w-1 rounded-r-sm ${isCompleted ? "mnx-bg-success" : hasMissingStandaloneDocuments ? "mnx-bg-danger" : "mnx-bg-accent-soft"}`}
                                                    />
                                                      ...
                                                      <div className="flex min-w-0 flex-1 items-center gap-3">
                                                        ...
                                                        <div className="flex min-h-9 min-w-0 flex-1 items-center">
                                                          <div className="text-base font-normal uppercase leading-none tracking-[0.04em] mnx-text-primary">
                                                            Filing Document
                                                            Verification{" "}
                                                            <span className="mnx-text-danger">
                                                              *
                                                            </span>
                                                          </div>
                                                        </div>
                                                    ...
                                                    <div className="ml-12 mt-3 space-y-3">
                                                      ...
                                                      <div className="space-y-3">
                                                        {activeNodeDocumentRequirements.map(
                                                          (
                                                            requirement: any,
                                                          ) => {
                                                              ...
                                                              >
                                                                ...
                                                                {uploadedAttachment ? (
                                                                  <FilingAttachmentValidityRow
                                                                    ...
                                                                    draftValidityDate={
                                                                      attachmentValidityDrafts[
                                                                        uploadedAttachment
                                                                          .id
                                                                      ] ??
                                                                      toDateInputValue(
                                                                        uploadedAttachment.validityDate,
                                                                      )
                                                                    }
                                                                    isEditingValidity={
                                                                      attachmentValidityEditors[
                                                                        uploadedAttachment
                                                                          .id
                                                                      ] ??
                                                                      Boolean(
                                                                    ...
                                                                    isSaving={
                                                                      loading ===
                                                                      `filing-attachment-validity-${uploadedAttachment.id}`
                                                                    }
                                                                    onDraftChange={(
                                                                      value,
                                                                    ) =>
                                                                      setAttachmentValidityDrafts(
                                                                        (
                                                                          prev,
                                                                        ) => ({
                                                                          ...prev,
                                                                    ...
                                                                    onSaveValidity={(
                                                                      ...
                                                                      void handleUpdateFilingAttachmentValidity(
                                                                        uploadedAttachment.id,
                                                                        value,
                                                                      )
                                                                    }
                                      ...
                                      {activeNodeRun.node.checklistItems
                                        ?.length > 0 && (
                                        <div className="space-y-3 pt-1">
                                          <h4 className="mnx-label mnx-text-primary">
                                            Stage Checklist Verification
                                          ...
                                          <div className="space-y-3.5">
                                            {activeChecklistItems.map(
                                              (item: any, index: number) => {
                                                ...
                                                const overdueMeta =
                                                  overdueChecklistItems.find(
                                                    (entry: any) =>
                                                      entry.checklistItemId ===
                                                      item.id,
                                                  );
                                                const checklistItemAttachments =
                                                  checklistAttachmentsByItem.get(
                                                    item.id,
                                                  ) || [];
                                                const mandatoryNodeDocumentsReady =
                                                  activeNodeDocumentRequirements
                                                    .filter(
                                                      (requirement: any) =>
                                                        requirement.required !==
                                                ...
                                                const mandatoryPhotoRequirementsReady =
                                                  (
                                                    activeNodeRun.node
                                                      .photoRequirements || []
                                                  )
                                                    ...
                                                    .every(
                                                      (requirement: any) => {
                                                        ...
                                                        return (
                                                          uploadedCount >=
                                                          (requirement.minPhotos ||
                                                            1)
                                                        );
                                                      },
                                                    );
                                                const checklistUploadsReady =
                                                  !checklistItemAllowsDirectUpload(
                                                    item,
                                                  ) ||
                                                  (item.minUploads || 0) ===
                                                    0 ||
                                                  checklistItemAttachments.length >=
                                                    (item.minUploads || 0);
                                                const isCurrentItem =
                                                  index ===
                                                ...
                                                const isLockedItem =
                                                  index >
                                                  currentChecklistItemIndex;
                                                const checklistRemarksReady =
                                                  !item.requiresRemarks ||
                                                  Boolean(resp.remarks?.trim());
                                                ...
                                                const hasValidationMissingChecklistItem =
                                                  (filingValidationWarning?.checklistItemIds.includes(
                                                    item.id,
                                                  ) &&
                                                    !resp.isChecked) ||
                                                  (isCurrentItem &&
                                                ...
                                                const shouldBlinkChecklistItem =
                                                  ...
                                                  (!checklistItemComplete ||
                                                    Boolean(
                                                      hasValidationMissingChecklistItem,
                                                    ));
                                                ...
                                                return (
                                                  <div
                                                    key={item.id}
                                                    className={`relative overflow-hidden rounded-xl border p-4 space-y-2.5 transition-all duration-200 ${
                                                      isLockedItem
                                                        ? "mnx-border mnx-bg-soft opacity-70"
                                                        : checklistItemComplete
                                                  ...
                                                  >
                                                    ...
                                                    <NeonCheckbox
                                                      ...
                                                      className={`group relative flex w-full items-start bg-transparent text-left transition-all [&>div:first-child]:mt-1 mnx-bg-surface [&_.neon-checkbox__box]:!shadow-none [&_.neon-checkbox__glow]:!opacity-0 ${
                                                        !canVerifyChecklistItem
                                                          ? "cursor-not-allowed"
                                                          : resp.isChecked
                                                            ? "hover:scale-[1.005]"
                                                      ...
                                                      label={
                                                        <span className="block min-w-0 flex-1 space-y-1">
                                                          <span className="block font-[family:var(--font-geist-sans)] text-lg uppercase leading-6 tracking-[0.12em] mnx-text-primary">
                                                            {item.label}{" "}
                                                            {item.isMandatory && (
                                                              <span className="mnx-text-danger font-bold">
                                                                *
                                                              </span>
                                                            )}
                                                          </span>
                                                      ...
                                                      overdueMeta && (
                                                        <div
                                                          className={cn(
                                                            ...
                                                            filingValidationWarning?.checklistDelayRemarkItemIds.includes(
                                                              item.id,
                                                            ) &&
                                                              !resp.delayRemarks?.trim() &&
                                                        ...
                                                        >
                                                          <div className="flex flex-wrap items-center gap-3">
                                                            <span className="font-semibold mnx-text-warning uppercase tracking-wide">
                                                              Overdue
                                                            </span>
                                                            <span className="mnx-numeric">
                                                              Due:{" "}
                                                      ...
                                                      item.requiresRemarks && (
                                                        <div
                                                          className={cn(
                                                            ...
                                                            filingValidationWarning?.checklistRemarkItemIds.includes(
                                                              item.id,
                                                            ) &&
                                                              !resp.remarks?.trim() &&
                                                              "animate-pulse-red border mnx-border-danger mnx-bg-surface p-2",
                                                              ...
                                                              {checklistItemAttachments.map(
                                                                (
                                                                  ...
                                                                  <FilingAttachmentValidityRow
                                                                    ...
                                                                    isSaving={
                                                                      loading ===
                                                                      `filing-attachment-validity-${attachment.id}`
                                                                    }
                                                                    onDraftChange={(
                                                                      value,
                                                                    ) =>
                                  ...
                                  {visibleNodeConditionalSections.length >
                                    0 && (
                                    <div
                                      className={`${filingPrimaryColumnClass} space-y-2.5 pt-0.5 ${isActiveStageBlocked ? "pointer-events-none opacity-60" : ""}`}
                                    >
                                      <h4 className="mnx-label mnx-text-primary">
                                        Conditional Sections & Documents
                                      </h4>
                                      <div className="space-y-2.5">
                                        {visibleNodeConditionalSections.map(
                                          (section: any) => (
                                            <div
                                              key={section.key}
                                              className="rounded-xl border mnx-border mnx-bg-soft p-3 space-y-2.5"
                                            >
                                              ...
                                              {filingToggleStates[
                                                ...
                                                section.unlocksFields?.length >
                                                  0 && (
                                                  <div className="grid grid-cols-1 gap-2.5 md:grid-cols-2">
                                                    {section.unlocksFields.map(
                                                      (field: any) => {
                                                        const isMissingField =
                                                          filingValidationWarning?.fieldKeys.includes(
                                                            field.key,
                                              ...
                                              {filingToggleStates[
                                                ...
                                                section.unlocksDocuments
                                                  ?.length > 0 && (
                                                  <div className="space-y-1.5">
                                                    {section.unlocksDocuments.map(
                                                      (requirement: any) => {
                                                        const uploadedAttachment =
                                                          activeNodeDocumentAttachmentsByKey.get(
                                                            requirement.key,
                                    ...
                                    {queryProcessingEnabled ? (
                                      <>
                                        <div className="mnx-bg-surface mnx-border mnx-border-warning overflow-hidden rounded-xl border mnx-border mnx-bg-surface shadow-sm">
                                          <div className="flex items-start justify-between gap-3 px-5 py-4">
                                            <div className="min-w-0 flex-1 space-y-1">
                                              <div className="grid grid-cols-[4px_minmax(0,1fr)] items-center gap-4">
                                                <span
                                                  className="h-7 w-1 rounded-sm mnx-bg-warning"
                                                  aria-hidden="true"
                                                />
                                                <h3 className="mnx-heading-3 mnx-text-warning">
                                                  Query Processing
                                                </h3>
                                              </div>
                                            ...
                                            <div className="flex shrink-0 items-center gap-2 self-start">
                                              {queryProcessingWarning ? (
                                                <WarningNoteToggle
                                                  title={
                                                    queryProcessingWarning.title
                                                  }
                                                  description={
                                                    queryProcessingWarning.description
                                                  }
                                                  open={
                                                    openWarningNote ===
                                                    "query-processing"
                                              ...
                                              <Button
                                                ...
                                                aria-label={
                                                  queryProcessingToggleEnabled
                                                    ? "Turn query processing off"
                                                    : "Turn query processing on"
                                                }
                                                disabled={
                                                  isSavingQueryProcessingDecision
                                                }
                                                onClick={() =>
                                                  void handleQueryProcessingToggleChange()
                                                }
                                                className={`inline-flex items-center gap-2 rounded-xl border mnx-border-warning mnx-bg-warning px-3 py-1.5 text-sm mnx-text-primary transition-all ${
                                                  isSavingQueryProcessingDecision
                                                    ? "cursor-not-allowed opacity-60"
                                                    : "mnx-shadow-panel"
                                                }`}
                                              >
                                                <span className="mnx-label mnx-text-warning whitespace-nowrap">
                                                  {queryProcessingToggleEnabled
                                                    ? "Queries On"
                                                    : "Queries Off"}
                                                </span>
                                                ...
                                                >
                                                  <span
                                                    className={`pointer-events-none absolute top-[2px] left-[2px] h-[18px] w-[18px] rounded-full border mnx-border-warning mnx-bg-surface shadow-sm transition-transform ${
                                                      queryProcessingToggleEnabled
                                                        ? "translate-x-[20px]"
                                                        : "translate-x-0"
                                                    }`}
                                            ...
                                            {filingSummaryCards
                                              ...
                                              .map((card) => {
                                                ...
                                                return (
                                                  <div
                                                    key={card.key}
                                                    className={`rounded-[var(--mn-radius-control)] border mnx-bg-surface px-3 py-3 mnx-shadow-panel ${toneClasses}`}
                                                  >
                                          ...
                                          {queryProcessingActive ? (
                                            <div className="space-y-3 px-4 py-3">
                                              <div className="grid gap-3 text-sm sm:grid-cols-2">
                                                <div className="space-y-2 mnx-text-muted">
                                                  <div className="flex items-center justify-between gap-3 sm:block">
                                                    <span className="mnx-label block mnx-text-muted">
                                                      Ref
                                                    </span>
                                                    <span className="text-sm font-medium mnx-text-primary sm:mt-1 sm:block">
                                                      {typeof queryProcessingState?.queryReferenceNumber ===
                                                        "string" &&
                                                      queryProcessingState.queryReferenceNumber.trim()
                                                        ? queryProcessingState.queryReferenceNumber
                                                        : primaryQuerySummary?.title ||
                                                          "Not Recorded"}
                                                    </span>
                                                  </div>
                                                  <div className="flex items-center justify-between gap-3 sm:block">
                                                    ...
                                                    <span className="text-sm font-medium mnx-text-primary sm:mt-1 sm:block">
                                                      {typeof queryProcessingState?.customsOfficerName ===
                                                        "string" &&
                                                ...
                                                <div className="space-y-2 mnx-text-muted">
                                                  <div className="flex items-center justify-between gap-3 sm:block">
                                                    ...
                                                    <span className="text-sm font-medium mnx-text-primary sm:mt-1 sm:block">
                                                      {typeof queryProcessingState?.queryReceivedAt ===
                                                        "string" &&
                                                      queryProcessingState.queryReceivedAt.trim()
                                                        ? new Date(
                                                            queryProcessingState.queryReceivedAt,
                                                          ).toLocaleDateString(
                                                            "en-IN",
                                                          )
                                                        : "Pending"}
                                              ...
                                              <div className="flex flex-col gap-2 sm:flex-row sm:justify-end">
                                                <Button
                                                  ...
                                                  onClick={() =>
                                                    setQueryProcessingPanelExpanded(
                                                      true,
                                                    )
                                                  }
                                                >
                                            ...
                                            <div className="px-4 py-3 text-sm mnx-text-muted">
                                              Turn on queries to reveal the
                                              customs query card, summary
                                              details, and manage actions for
                                              this filing step.
                                            </div>
                                          )}
                                        </div>

                                        {queryProcessingPanelExpanded &&
                                        queryProcessingActive ? (
                                          <Modal
                                            ...
                                            <div className="space-y-5">
                                              ...
                                              queryProcessingStage ===
                                                ...
                                                <div className="rounded-xl border mnx-border-accent mnx-bg-accent-soft p-4 text-sm mnx-text-primary">
                                                  All customs queries are
                                                  cleared for this workflow
                                                  stage. You can continue to the
                                                  next stage or record an
                                                  additional query if customs
                                                  raises another one.
                                                  <div className="mt-3">
                                                    <Button
                                                      type="button"
                                                ...
                                                <div className="flex items-start justify-between gap-3">
                                                  <div>
                                                    ...
                                                    <p className="pl-[13px] text-sm mnx-text-muted">
                                                      Capture the customs note,
                                                      reference number, officer,
                                                      and received date.
                                                    </p>
                                                  </div>
                                                  <Badge variant="default">
                                                    {activeNodeQueries.length}{" "}
                                                    Case
                                                    {activeNodeQueries.length ===
                                                    1
                                                      ? ""
                                              ...
                                              <div className="space-y-3 mnx-form-section">
                                                <div className="flex items-center justify-between gap-3">
                                                  <div>
                                                    <h4>Query Cases</h4>
                                                    <p className="pl-[13px] text-sm mnx-text-muted">
                                                      View responses, respond
                                                      offline, submit updates,
                                                      clear, or reopen any
                                                      customs query.
                                                    </p>
                                                  </div>
                                                ...
                                                {activeNodeQueries.map(
                                                  (query: any) => {
                                                    const queryMessages =
                                                      activeNodeQueryMessages.filter(
                                                        (message: any) =>
                                                          message.queryId ===
                                                          query.id,
                                                      );
                                                        ...
                                                        <summary className="flex cursor-pointer list-none items-start justify-between gap-3 px-4 py-3">
                                                          <div className="min-w-0">
                                                            ...
                                                            <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-[11px] mnx-text-muted">
                                                              {query.id ===
                                                                queryProcessingState?.latestQueryId &&
                                                              typeof queryProcessingState?.queryReferenceNumber ===
                                                                "string" &&
                                                              queryProcessingState.queryReferenceNumber.trim() ? (
                                                                <span>
                                                        ...
                                                        <div className="space-y-4 border-t mnx-border px-4 py-4">
                                                          ...
                                                          <div className="flex flex-wrap justify-end gap-2">
                                                            <Button
                                                              ...
                                                              variant="outline"
                                                              onClick={() =>
                                                                handleAddFilingQueryComment(
                                                                  query.id,
                                                                )
                                                              }
                                                              disabled={
                                                                loading ===
                                                                `filing-query-${query.id}`
                                                              }
                                                            >
                                                              Save Response
                                                              Update
                                                                ...
                                                                <Button
                                                                  ...
                                                                  onClick={() =>
                                                                    handleUpdateFilingQueryStatus(
                                                                      query.id,
                                                                      "REPLIED",
                                                                      buildFilingQueryResponseMessage(
                                                                        query.id,
                                                                        query.details,
                                                                      ),
                                                                    )
                                                                ...
                                                                {queryMessages.map(
                                                                  (
                                                                    ...
                                                                    >
                                                                      ...
                                                                      <p className="mt-2 text-sm mnx-text-primary">
                                                                        {
                                                                          message.body
                                                                        }
                                                                      </p>
                                        ...
                                        <Modal
                                          ...
                                          onClose={
                                            handleCloseQueryToggleOffModal
                                          }
                                          className="max-w-lg"
                                        >
                                          <div className="space-y-5">
                                            <div className="rounded-[var(--mn-radius-panel)] border mnx-border-warning bg-[linear-gradient(135deg,color-mix(in srgb, var(--mnx-surface) 72%, transparent),color-mix(in srgb, var(--mnx-surface) 72%, transparent))] px-4 py-3 mnx-shadow-panel">
                                              <div className="flex items-start gap-3">
                                                <span
                                                  className="mt-0.5 h-10 w-1.5 rounded-full mnx-bg-warning"
                                                  aria-hidden="true"
                                                />
                                                <div className="space-y-1">
                                                  <p className="text-sm font-medium mnx-text-primary">
                                                    Query processing can be
                                                    turned off for this filing
                                                    stage after adding
                                                    operational remarks.
                                                  </p>
                                                  <p className="text-xs mnx-text-muted">
                                            ...
                                            <div className="rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-soft px-4 py-4 mnx-shadow-panel">
                                              <div className="space-y-2">
                                                <label className="mnx-label block mnx-text-muted">
                                                  Remarks for turning off query
                                                  processing *
                                                </label>
                                                <Textarea
                                                  rows={4}
                                                  ...
                                                  className="w-full rounded-[var(--mn-radius-control)] border mnx-border mnx-bg-surface px-4 py-3 text-sm mnx-shadow-panel"
                                                  disabled={
                                                    loading ===
                                                    "filing-toggle-query_processing"
                                                  }
                                                />
                                              </div>
                                            </div>
                                            ...
                                            <div className="flex justify-end gap-2 border-t mnx-border pt-1">
                                              ...
                                              <Button
                                                type="button"
                                                onClick={() =>
                                                  void handleConfirmQueryProcessingToggleOff()
                                                }
                                                disabled={
                                                  loading ===
                                                  "filing-toggle-query_processing"
                                        ...
                                        <div className="flex flex-1">
                                          <div className="flex min-h-full w-full flex-col overflow-hidden rounded-[var(--mn-radius-panel)] border mnx-border mnx-bg-surface mnx-shadow-panel">
                                            <div className="flex flex-1 flex-col space-y-6 px-5 py-5">
                                              <div className="flex items-start gap-4">
                                                ...
                                                <div className="space-y-0.5">
                                                  <h3 className="mnx-heading-3 mnx-text-primary">
                                                    {isFinalFilingNode
                                                      ? "Final Filing Remarks"
                                                      : "Completion Comments / Remarks"}{" "}
                                                    {activeNodeRun.node
                                                      .commentsRequired ? (
                                                      <span className="mnx-text-danger">
                                                        *
                                              ...
                                              <Textarea
                                                ...
                                                value={nodeRemarks}
                                                onChange={(e) =>
                                                  setNodeRemarks(e.target.value)
                                                }
                                                placeholder="Enter comments, observations, or checklist outcome..."
                                                className={cn(
                                                  "min-h-[112px] flex-1 w-full resize-none overflow-hidden rounded-[var(--mn-radius-control)] border mnx-border mnx-bg-surface px-5 py-4 text-sm font-sans mnx-shadow-panel",
                                                  filingValidationWarning?.miscKeys.includes(
                                                    "nodeRemarks",
                                                  ) &&
                                                    !nodeRemarks.trim() &&
                                                    "animate-pulse-red mnx-border-danger",
                                              ...
                                              {activeNodeIsOverdue ? (
                                                ...
                                                >
                                                  <div className="flex flex-wrap items-center justify-between gap-2">
                                                    <label className="mnx-label block mnx-text-warning">
                                                      Stage Delay Remarks{" "}
                                                      {activeNodeDelayRemarksRequired
                                                        ? "*"
                                                        : ""}
                                                    </label>
                                                    {activeNodeSlaDueDate ? (
                                                      <span className="mnx-numeric text-xs mnx-text-muted">
                                                        Due:{" "}
                                                        {activeNodeSlaDueDate.toLocaleDateString(
                                                          "en-IN",
                                                        )}{" "}
                                                        · {activeNodeDelayDays}{" "}
                                                        day(s) delayed
                                              ...
                                              {isFinalFilingNode ? (
                                                <div className="rounded-[var(--mn-radius-control)] border mnx-border mnx-bg-soft p-4 text-sm mnx-text-muted">
                                                  Completing this node will
                                                  finalize the filing workflow
                                                  and transition the job stage
                                                  to <strong>FILED</strong>.
                                                </div>
                                              ) : null}
                                            </div>
                                          </div>
                                  ...
                                  {activeNodeRun ? (
                                    <div className="space-y-4 xl:col-span-2">
                                      <FilingWorkflowStatusBanner
                                        ...
                                        nextStageName={
                                          outgoingEdges.length > 0
                                            ? nextWorkflowTargetLabel
                                            : null
                                        }
                                        isBlocked={isActiveStageBlocked}
                                        isCompleting={
                                          loading === "filing-complete"
                                        }
                                        activeStatusLabel={
                                          filingBannerStatus.label
                                        }
                                        activeStatusDescription={
                                          filingBannerStatus.description
                                        }
                                      />
                                      <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
                                        ...
                                        <div className="flex flex-wrap gap-3 xl:shrink-0">
                                          <Button
                                            ...
                                            className="gap-2 rounded-[var(--mn-radius-control)] px-5"
                                          >
                                            <Database size={16} />
                                            Save Draft
                                          </Button>
                                          {hasPreviousFilingStage ? (
                                            <Button
                                              ...
                                              onClick={() => {
                                                ...
                                                setGoBackReason("");
                                                setSelectedJumpBackNodeKey(
                                                  jumpBackTargets[0]?.nodeKey ||
                                                    "",
                                                );
                                                setGoBackOpen(true);
                                              }}
                                              className="gap-2 rounded-[var(--mn-radius-control)] mnx-border-accent mnx-bg-accent-soft px-5 mnx-text-accent"
                                            >
                                              <Undo2 size={16} />
                                          ...
                                          {showReturnToCurrentStageShortcut ? (
                                            <Button
                                              ...
                                              disabled={loading !== null}
                                              onClick={() =>
                                                void handleReturnToCurrentStage()
                                              }
                                              className="gap-2 rounded-[var(--mn-radius-control)] mnx-border-info mnx-bg-info px-5 mnx-text-info mnx-text-accent"
                                            >
                                              <RotateCcw size={16} />
                                              {loading === "filing-go-back"
                                                ? "Returning..."
                                  ...
                                  {activeNodeRun.node.photoRequirements
                                    ?.length > 0 && (
                                    <div
                                      className={`${filingPrimaryColumnClass} space-y-4 border-t mnx-border pt-4 ${isActiveStageBlocked ? "pointer-events-none opacity-60" : ""}`}
                                    >
                                      <h4 className="mnx-label mnx-text-primary">
                                        Required Photograph / Document Uploads
                                      </h4>
                                      <div className="space-y-4">
                                        {activeNodeRun.node.photoRequirements.map(
                                          (pr: any) => {
                                            ...
                                            return (
                                              ...
                                              >
                                                <div>
                                                  ...
                                                  {pr.description && (
                                                    <p className="text-[11px] mnx-text-muted mt-0.5">
                                                      {pr.description}
                                                    </p>
                                                  )}
                                                            ...
                                                            <tr key={a.id}>
                                                              <td className="truncate max-w-[200px] text-xs font-medium mnx-text-primary">
                                                                <a
                                                                  ...
                                                                  target="_blank"
                                                                  rel="noreferrer"
                                                                  className="mnx-text-accent hover:underline flex items-center gap-1 font-semibold"
                                                                >
                                                                  <ExternalLink
                                                                    size={12}
                                                                    className="shrink-0"
                                                              ...
                                                              <td className="mnx-numeric text-xs font-mono">
                                                                {(
                                                                  a.fileSize /
                                                                  1024
                                                                ).toFixed(
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    returnToCurrentTarget ? (
                                      <div className="rounded-2xl border mnx-border-info mnx-bg-info px-4 py-3">
                                        <div className="space-y-1">
                                          <span className="mnx-label mnx-text-info mnx-text-accent">
                                            Returning To
                                          </span>
                                          <p className="text-sm font-semibold mnx-text-primary">
                                            {returnToCurrentTarget.nodeName}
                                          </p>
                                    ...
                                    <label className="block space-y-1.5">
                                      <span className="mnx-label">
                                        {goBackMode === "return"
                                          ? "Reason for return *"
                                          : "Reason for jump-back *"}
                                      </span>
                                      <Textarea
                                        rows={3}
                                        value={goBackReason}
                                        onChange={(e) =>
                                          setGoBackReason(e.target.value)
                                        }
                                        placeholder={
                                          goBackMode === "return"
                                            ? "Explain why the workflow should return to the current filing stage..."
                                            : "Explain why this filing stage must be reworked..."
                                        }
                              ...
                              <div className="mnx-bg-surface mnx-border mnx-border-accent rounded-xl border mnx-border mnx-bg-surface p-5 space-y-4 shadow-sm">
                                <div className="flex flex-wrap items-center gap-3">
                                  ...
                                  <div className="space-y-1">
                                    <div className="grid grid-cols-[4px_minmax(0,1fr)] items-center gap-3">
                                      ...
                                      />
                                      <h4 className="mnx-heading-3 mnx-text-primary">
                                        Customs Filing Workflow Complete
                                      </h4>
                                    </div>
                                ...
                                <p className="max-w-xl text-sm mnx-text-muted">
                                  All blueprint checklist checks have been
                                  completed and the customs submission has been
                                  filed. The job stage is updated to{" "}
                                  <strong>FILED</strong>.
                                </p>
                                <div className="grid grid-cols-2 gap-4 rounded-xl border mnx-border mnx-bg-soft p-4 text-xs max-w-md">
                                  ...
                                  <div>
                                    ...
                                    <span className="font-medium mnx-text-primary mnx-numeric">
                                      {job.filing.filingRef || "Completed"}
                                    </span>
                                  </div>
                                </div>
                              </div>
                  ...
                  <div className="grid gap-6 xl:grid-cols-[minmax(360px,0.95fr)_minmax(420px,1.05fr)] xl:gap-0">
                    {canCreateExpenseRequests ? (
                      <div className="space-y-4 mnx-bg-surface xl:pr-6">
                        <div className="grid grid-cols-[4px_minmax(0,1fr)] items-center gap-3">
                          ...
                          />
                          <h4 className="mnx-heading-3 mnx-text-primary">
                            New Clearance Expense Request
                          </h4>
                        </div>

                        <form
                          onSubmit={handleCreateExpenseRequest}
                          className="space-y-4"
                        >
                          <div className="flex flex-col justify-between gap-4 rounded-xl border mnx-border mnx-bg-surface p-4">
                            <div className="flex items-start space-x-3">
                              <NeonCheckbox
                                ...
                                onChange={(e) =>
                                  setExpenseUrgent(e.target.checked)
                                }
                                className="mt-1"
                                label={
                                  <div>
                                    <span className="block text-sm font-semibold mnx-text-primary">
                                      Escalate to URGENT Payment
                                    </span>
                                    <span className="text-xs mnx-text-muted">
                                      Request accounts to disburse payment
                                      immediately to resolve critical port
                                      blocks.
                                    </span>
                                  </div>
                                }
                            ...
                            {expenseUrgent ? (
                              <div className="max-w-md flex-1 space-y-1">
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    setExpenseUrgencyReason(e.target.value)
                                  }
                          ...
                          <div className="grid gap-3 md:grid-cols-2">
                            <div className="space-y-1">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setExpenseUpiNumber(e.target.value)
                                }
                            ...
                            <div className="space-y-1">
                              ...
                              <Input
                                ...
                                value={expenseUpiId}
                                onChange={(e) =>
                                  setExpenseUpiId(e.target.value)
                                }
                                className="h-9 w-full text-xs"
                              />
                            </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="space-y-3">
                              {expenseLines.map((line, index) => (
                                <div
                                  key={index}
                                  className="grid grid-cols-1 items-end gap-3 border-b mnx-border pb-3 md:grid-cols-2 md:border-b-0 md:pb-0"
                                >
                                  <div className="space-y-1">
                                  ...
                                  <div className="md:col-span-2">
                                    <FileUploadField
                                      ...
                                      selectedFiles={line.receiptFiles.map(
                                        (file) => ({
                                          file,
                                          name: file.name,
                                          sizeBytes: file.size,
                      ...
                      <div className="mnx-bg-surface xl:pr-6">
                        <p className="text-sm font-medium mnx-text-primary">
                          Expense records are view-only for your role.
                        </p>
                        <p className="mt-1 text-xs mnx-text-muted">
                          You can track status, line items, payout details, and
                          approval history after the filing stage is complete.
                        </p>
                      </div>
                    )}
                    ...
                    <div className="space-y-4 mnx-bg-surface xl:border-l mnx-border xl:pl-6">
                      ...
                      {job.expenseRequests?.length === 0 ? (
                        <p className="text-xs italic mnx-text-muted">
                          No expenses requested for this job clearance.
                        </p>
                      ) : (
                        <div className="space-y-3">
                          {job.expenseRequests.map((request: any) => {
                            ...
                            const canPayThisExpense =
                              canProcessExpensePayments &&
                              ["APPROVED", "READY_FOR_DISBURSEMENT"].includes(
                                String(request.status),
                              );
                            return (
                              <div
                                key={request.id}
                                className="space-y-3 rounded-xl border mnx-border mnx-bg-surface p-4"
                              >
                                <div className="flex flex-wrap items-center justify-between gap-2">
                                  <div>
                                    <p className="text-sm font-medium mnx-text-primary mnx-numeric">
                                      Rs. {amount.toLocaleString("en-IN")}
                                    </p>
                                    <p className="mt-0.5 text-xs mnx-text-muted">
                                      Ref: {request.id} - Requested by{" "}
                                ...
                                <div className="grid gap-2 md:grid-cols-2">
                                  {request.lines.map((line: any) => (
                                    <div
                                      key={line.id}
                                      className="rounded-lg border mnx-border mnx-bg-soft p-3"
                                    >
                                      <p className="mnx-label">
                                        {line.category}
                                      </p>
                                      ...
                                      {getReceiptLinks(
                                        line.supportingDocumentKey,
                                      ).length ? (
                                        <div className="mt-2 flex flex-wrap gap-2">
                                          {getReceiptLinks(
                                            line.supportingDocumentKey,
                                          ).map((receiptLink, receiptIndex) => (
                                            <a
                                  ...
                                  <div className="grid gap-2 rounded-lg border mnx-border mnx-bg-surface p-3 md:grid-cols-2">
                                    {request.upiNumber ? (
                                      <div>
                                        ...
                                        <p className="mt-1 text-xs mnx-text-primary mnx-numeric">
                                          {request.upiNumber}
                                        </p>
                                      </div>
                                    ) : null}
                                  ...
                                  <div className="rounded-lg border mnx-border-success mnx-bg-success p-3 text-xs mnx-text-primary">
                                    {request.payments.map((payment: any) => (
                                      <div key={payment.id}>
                                        ...
                                        {getPaymentProofLinks(
                                          payment.paymentProofKey,
                                        ).length ? (
                                  ...
                                  <div className="space-y-1 border-t mnx-border pt-3">
                                    ...
                                    {request.statusHistory
                                      ...
                                      .map((entry: any) => (
                                        <p
                                          key={entry.id}
                                          className="text-xs mnx-text-muted"
                                        >
                                ...
                                {expReviewId === request.id ? (
                                  <div className="grid gap-2 rounded-lg border mnx-border mnx-bg-surface p-3 md:grid-cols-[minmax(0,1fr)_auto]">
                                    <Input
                                      ...
                                      onChange={(e) =>
                                        setExpReviewRemarks(e.target.value)
                                      }
                                      placeholder={
                                        expReviewStatus === "REJECTED"
                                          ? "Rejection reason"
                                ...
                                {expenseClarificationId === request.id ? (
                                  <div className="grid gap-2 rounded-lg border mnx-border mnx-bg-surface p-3 md:grid-cols-[minmax(0,1fr)_auto]">
                                    ...
                                    <Button
                                      size="sm"
                                      onClick={handleExpenseClarification}
                                      disabled={loading !== null}
                                    >
                                ...
                                {payRequestId === request.id ? (
                                  <form
                                    onSubmit={handlePostExpensePayment}
                                    className="grid gap-2 rounded-lg border mnx-border mnx-bg-surface p-3 md:grid-cols-6"
                                  >
                                    <Input
                                      type="number"
                                      required
                                    ...
                                    <FileUploadField
                                      ...
                                      selectedFiles={payProofFiles.map(
                                        (file) => ({
                                          file,
                                          name: file.name,
                                          sizeBytes: file.size,
                                  ...
                                  <div className="flex flex-wrap justify-end gap-2 border-t mnx-border pt-3">
                                    ...
                                    {canMarkReadyThisExpense ? (
                                      <Button
                                        ...
                                        size="sm"
                                        onClick={() =>
                                          handleReadyForExpenseDisbursement(
                                            request.id,
                                          )
                                        }
                                        disabled={loading !== null}
                ...
                >
                  <div className="space-y-4">
                    ...
                    <p className="max-w-xl text-sm mnx-text-accent font-medium font-sans">
                      All checklist preparation checks have been validated and
                      the customs declaration has been filed.
                    </p>
                  </div>
                </MilestoneCard>
              ) : null}
              ...
              {activeTab === "overview" && (
                ...
                >
                      ...
                      <div className="mnx-cha-section-header flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="space-y-0.5">
                            ...
                            <p className="text-xs mnx-text-muted">
                              Key shipment and clearance details for this job.
                            </p>
                          </div>
                        </div>
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            navigateToWorkspaceTab("additionalData")
                          }
                        >
                          View Details
                        </Button>
                          ...
                          <div key={item.label} className="px-3 py-3">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="min-w-0">
                                ...
                                <p
                                  className={cn(
                                    "mt-1 text-sm mnx-text-primary",
                                    item.numeric && "mnx-numeric",
                                  )}
                                >
                                  {item.value}
                                </p>
                    ...
                    <section className="mnx-bg-surface mnx-border h-full p-5">
                      <div className="mnx-cha-section-header flex items-center gap-3">
                        ...
                        <div className="space-y-0.5">
                          ...
                          <p className="text-xs mnx-text-muted">
                            Validity and deadline signals for this shipment.
                          </p>
                        </div>
                      </div>
                      <div className="mt-4 space-y-3">
                        {overviewDateItems.map((item) => (
                          <div
                            key={item.label}
                            className="mnx-bg-soft mnx-border flex items-center justify-between gap-3 px-3 py-3"
                          >
                    ...
                    <section className="mnx-bg-surface mnx-border h-full p-5">
                      <div className="mnx-cha-section-header flex items-center gap-3">
                        ...
                        <div className="space-y-0.5">
                          ...
                          <p className="text-xs mnx-text-muted">
                            Common job actions and workspace shortcuts.
                          </p>
                        </div>
                      </div>
                  ...
                  <section className="mnx-bg-surface mnx-border p-5">
                    ...
                    <div className="mt-4 overflow-hidden rounded-[var(--mn-radius-panel)]">
                      {overviewRecentLogs.length === 0 ? (
                        ...
                        <div>
                          {overviewRecentLogs.map((log: any) => (
                            <div
                              key={log.id}
                              className="grid gap-3 px-4 py-3 md:grid-cols-[minmax(0,240px)_minmax(0,1fr)_130px_100px_160px] md:items-center"
                            >
                              <div className="flex items-center gap-3">
                                <span
                                  className={cn(
                                    "flex size-8 shrink-0 items-center justify-center rounded-full",
                                    String(log.event || "").includes("QUERY") ||
                                      String(log.event || "").includes("query")
                                      ? "mnx-bg-warning mnx-text-warning"
                                      : "mnx-bg-accent-soft mnx-text-accent",
                                  )}
                                ...
                                <p className="mnx-label mnx-text-primary">
                                  {String(log.event || "Activity").replace(
                                    /_/g,
                                    " ",
                                  )}
                                </p>
                              ...
                              <p className="text-sm mnx-text-muted">
                                {log.remarks ||
                                  "Operational update recorded for this job."}
                              </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="grid grid-cols-[4px_minmax(0,1fr)] items-center gap-3">
                      ...
                      />
                      <h3 className="mnx-heading-3 mnx-text-primary">
                        Client Advance Collections
                      </h3>
                    </div>
                    <span
                      className={`text-xs font-bold uppercase tracking-wider ${
                        job.customerAdvance.status === "FULLY_RECEIVED"
                          ? "mnx-text-success"
                          : "mnx-text-warning"
                      }`}
                    >
                      Collection:{" "}
                      {job.customerAdvance.status.replace(/_/g, " ")}
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div className="space-y-4">
                      <div className="border mnx-border p-4 rounded-2xl space-y-4">
                        <span className="mnx-label block mnx-text-primary">
                          Billing expected terms
                        </span>

                        <div className="space-y-1">
                          <label className="mnx-label block">
                            Expected Advance Amount (Rs.) *
                          </label>
                          <Input
                            type="number"
                        ...
                        <div className="space-y-1">
                          <label className="mnx-label block">
                            Assigned Collections Agent
                          </label>
                          <NativeSelect
                            value={advanceAssigneeId}
                            onChange={(e) =>
                              setAdvanceAssigneeId(e.target.value)
                            }
                            className="w-full text-xs"
                          >
                        ...
                        <div className="flex gap-2">
                          <Button
                            onClick={handleUpdateAdvanceExpected}
                            disabled={loading !== null}
                          ...
                          <Button
                            variant="outline"
                            onClick={() =>
                              setShowWaiveAdvance(!showWaiveAdvance)
                            }
                      ...
                      {showWaiveAdvance && (
                        <div className="border mnx-border-danger mnx-bg-danger p-4 rounded-2xl space-y-3">
                          <span className="mnx-label mnx-text-danger block">
                            Exempt / Waive Advance Requirement
                          </span>
                          <Input
                            type="text"
                            ...
                            onChange={(e) =>
                              setWaiveAdvanceReason(e.target.value)
                            }
                          ...
                          <div className="flex justify-end gap-2">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => setShowWaiveAdvance(false)}
                            >
                              Cancel
                            </Button>
                            <Button
                    ...
                    <div className="space-y-4">
                      ...
                      {job.customerAdvance.status !== "NOT_REQUIRED" &&
                        job.customerAdvance.status !== "FULLY_RECEIVED" && (
                          <form
                            onSubmit={handleRecordAdvanceReceipt}
                            className="border mnx-border p-4 rounded-2xl space-y-4"
                          >
                            <span className="mnx-label block mnx-text-primary">
                              Record Received Receipt
                            </span>
                            ...
                            <div className="space-y-1">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setReceiptRemarks(e.target.value)
                                }
                                className="w-full text-xs"
                              />
                            </div>
                      ...
                      <div className="space-y-3">
                        <span className="mnx-label block mnx-text-primary">
                          Payment Receipts Catalog
                        </span>
                        {job.customerAdvance.receipts?.length === 0 ? (
                          <p className="text-xs mnx-text-muted italic">
                            No receipts recorded for this job advance.
                          </p>
                        ) : (
                          <div className="space-y-2">
                            {job.customerAdvance.receipts.map((r: any) => (
                              <div
                                key={r.id}
                                className="p-3 mnx-bg-soft border mnx-border rounded-2xl flex items-center justify-between text-xs"
                              >
                                <div>
                                  <span className="font-bold mnx-text-accent block">
                                    Rs.{" "}
                      ...
                      <div className="flex flex-col md:flex-row gap-4 md:items-center justify-between p-4 border mnx-border rounded-2xl mnx-bg-surface">
                        <div className="flex items-start space-x-3">
                          <NeonCheckbox
                            ...
                            label={
                              <div>
                                <span className="text-sm font-semibold mnx-text-primary block">
                                  Escalate to URGENT Payment
                                </span>
                                <span className="text-xs mnx-text-muted">
                                  Request accounts to disburse payment
                                  immediately to resolve critical port blocks.
                                </span>
                              </div>
                            }
                          />
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-3">
                          {expenseLines.map((line, index) => (
                            <div
                              key={index}
                              className="grid grid-cols-1 md:grid-cols-6 gap-3 items-end border-b mnx-border pb-3 md:pb-0 md:border-b-0"
                            >
                              {/* category */}
                    ...
                    {job.expenseRequests?.length === 0 ? (
                      ...
                      <div className="space-y-4">
                        {job.expenseRequests.map((req: any) => {
                          ...
                          const sum = req.lines.reduce(
                            (tot: number, l: any) => tot + Number(l.amount),
                            0,
                          );
                          const canReviewThisExpense =
                            canReviewExpenseRequests &&
                          ...
                          return (
                            <div
                              key={req.id}
                              className={`overflow-hidden rounded-xl border mnx-bg-surface transition-all ${
                                req.isUrgent
                            ...
                            >
                              ...
                              <div className="grid gap-3 mnx-bg-surface px-4 py-3 md:grid-cols-[minmax(0,1.3fr)_110px_110px_auto] md:items-center">
                                ...
                                >
                                  ...
                                  <span className="min-w-0">
                                    ...
                                    <span className="mt-0.5 block truncate text-sm font-medium mnx-text-primary">
                                      {req.lines[0]?.category || "Expense"} •{" "}
                                      {req.lines.length} line
                                      {req.lines.length === 1 ? "" : "s"}
                                    </span>
                                    <span className="mt-0.5 block truncate text-xs mnx-text-muted">
                                      Requested by{" "}
                                      {req.requestedBy?.name || "Team Member"}
                                    </span>
                                    {req.isUrgent && (
                                ...
                                <div className="flex items-center justify-between gap-2 md:block">
                                  <span className="mnx-label md:hidden">
                                    Amount
                                  </span>
                                  <span className="text-sm mnx-text-accent mnx-numeric">
                                    Rs. {sum.toLocaleString("en-IN")}
                                  </span>
                                </div>
                                ...
                                <div className="space-y-4 border-t mnx-border p-4">
                                  ...
                                  <div className="space-y-1.5 pl-2 border-l mnx-border">
                                    {req.lines.map((l: any) => (
                                      <div
                                        key={l.id}
                                        className="flex flex-col gap-1 text-xs md:flex-row md:items-center md:justify-between"
                                      >
                                        <div>
                                          <span className="mnx-text-primary">
                                            <strong className="mnx-text-muted uppercase">
                                              {l.category}
                                            </strong>
                                            : {l.purpose}
                                          </span>
                                          {getReceiptLinks(
                                            l.supportingDocumentKey,
                                          ).length ? (
                                            <span className="ml-0 inline-flex flex-wrap gap-2 md:ml-2">
                                              {getReceiptLinks(
                                                l.supportingDocumentKey,
                                              ).map(
                                                (receiptLink, receiptIndex) => (
                                                  <a
                                                    key={`${receiptLink}-${receiptIndex}`}
                                                    href={receiptLink}
                                                    target="_blank"
                                        ...
                                        <span className="font-mono mnx-numeric mnx-text-muted">
                                          Rs.{" "}
                                  ...
                                  {req.isUrgent && req.urgencyReason && (
                                    <div className="p-3 mnx-bg-danger border mnx-border-danger rounded-lg text-xs leading-relaxed mnx-text-danger">
                                      <strong>Urgent escalation reason:</strong>{" "}
                                      "{req.urgencyReason}"
                                    </div>
                                  )}
                                  ...
                                  {req.queries?.map((q: any) => (
                                    <div
                                      key={q.id}
                                      className="p-3 mnx-bg-warning border mnx-border-warning rounded-lg text-xs space-y-2"
                                    >
                                      <div>
                                        <strong className="mnx-text-warning">
                                          DISBURSEMENT QUERY:
                                        </strong>
                                        <p className="mnx-text-primary italic mt-0.5">
                                          "{q.queryText}"
                                        </p>
                                        <span className="text-[10px] mnx-text-muted block mt-0.5">
                                          Raised by: {q.author?.name}
                                        </span>
                                      </div>
                                  ...
                                  {req.payments?.map((p: any) => (
                                    <div
                                      key={p.id}
                                      className="p-3 mnx-bg-success border mnx-border-success rounded-lg text-xs flex flex-col md:flex-row md:items-center justify-between gap-2"
                                    >
                                      <div>
                                        <span className="font-semibold mnx-text-success block">
                                          Payment Disbursed via{" "}
                                          {p.paymentMethod}
                                        </span>
                                        <span className="text-[10px] mnx-text-muted">
                                          Txn Ref: {p.transactionReference} -
                                          Paid by {p.paidBy?.name}
                                        </span>
                                        {getPaymentProofLinks(p.paymentProofKey)
                                          .length ? (
                                          <div className="mt-1 flex flex-wrap gap-2">
                                            {getPaymentProofLinks(
                                              p.paymentProofKey,
                                  ...
                                  {escRequestId === req.id && (
                                    <div className="p-4 border mnx-border-warning mnx-bg-warning rounded-2xl space-y-3">
                                      <span className="mnx-label mnx-text-warning font-bold block">
                                        Escalate Request to Urgent
                                      </span>
                                      <Input
                                        type="text"
                                        ...
                                        onChange={(e) =>
                                          setEscUrgencyReason(e.target.value)
                                        }
                                        className="text-xs w-full"
                                      />
                                      <div className="flex justify-end gap-2">
                                        <Button
                                          variant="outline"
                                          size="sm"
                                          onClick={() => setEscRequestId(null)}
                                        >
                                          Cancel
                                        </Button>
                                        <Button
                                          size="sm"
                                          onClick={handleEscalateExpense}
                                          disabled={loading !== null}
                                        >
                                          Escalate Request
                                        </Button>
                                  ...
                                  {payRequestId === req.id && (
                                    <form
                                      onSubmit={handlePostExpensePayment}
                                      className="p-4 border mnx-border-accent mnx-bg-accent-soft rounded-2xl space-y-4"
                                    >
                                      <span className="mnx-label mnx-text-accent block">
                                        Post Payment Disbursement Confirmation
                                      </span>
                                  ...
                                  {queryRequestId === req.id && (
                                    <div className="p-4 border mnx-border-warning mnx-bg-warning rounded-2xl space-y-3">
                                      <span className="mnx-label mnx-text-warning font-bold block">
                                        Raise Payment Discrepancy Query
                                      </span>
                                      <Input
                                        type="text"
                                  ...
                                  <div className="flex justify-end gap-2 border-t mnx-border pt-3 text-xs">
                                    ...
                                    {isPaid && (
                                      <>
                                        ...
                                        <Button
                                          onClick={() =>
                                            handleAcknowledgeExpense(req.id)
                                          }
                                          disabled={loading !== null}
              ...
              {activeTab === "audit" && (
                <div className="space-y-4">
                  <div className="grid grid-cols-[4px_minmax(0,1fr)] items-center gap-3">
                    ...
                    />
                    <h3 className="mnx-heading-3 mnx-text-primary">
                      Job Auditing History Trail
                    </h3>
                  </div>

                  {job.auditLogs?.length === 0 ? (
                    <p className="text-xs mnx-text-muted">
                      No audit log records for this clearance.
                    </p>
                  ) : (
                    <div className="relative pl-6 space-y-4 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-outline-variant/40">
                      {job.auditLogs.map((log: any) => (
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between">
                            <span className="font-bold mnx-text-primary">
                          ...
                          <div className="flex gap-4 text-[10px] mnx-text-muted pt-0.5">
                            ...
                            {log.newState && (
                              <span>
                                New State: <strong>{log.newState}</strong>
                              </span>
                            )}
                          </div>
                        </div>
              ...
              {filingInstance?.nodeRuns?.length === 0 ? (
                ...
                filingInstance?.nodeRuns?.map((run: any) => {
                  ...
                  return (
                    <div
                      key={run.id}
                      className="rounded-xl border mnx-border mnx-bg-surface p-4"
                    >
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        <div>
                          <div className="flex flex-wrap items-center gap-2">
                            <h4
                              className={`text-sm font-medium ${isCurrent ? "mnx-text-accent" : "mnx-text-primary"}`}
                            >
                        ...
                        <span className="text-[11px] mnx-text-muted">
                          ...
                          {run.completedAt
                            ? ` - Finished ${new Date(run.completedAt).toLocaleString("en-IN")}`
                            : ""}
                        </span>
                      </div>
                      ...
                      {run.completedBy ? (
                        <p className="mt-3 text-xs mnx-text-muted">
                          Completed by:{" "}
                          <strong className="mnx-text-primary">
                            {run.completedBy.name}
                          </strong>
                        </p>
                      ) : null}
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border mnx-border-danger mnx-bg-danger p-4 text-sm mnx-text-primary">
                ...
                <p className="mt-1 mnx-text-muted">
                  Deleting this job affects linked CHA workflows, audit
                  visibility, and operational references.
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs mnx-text-muted">
                    Enter exactly:{" "}
                    <span className="mnx-text-primary">delete job</span>
                  </p>
                </div>
              </div>
          ...
          >
            <div className="space-y-4">
              <div className="rounded-2xl border mnx-border-danger mnx-bg-danger p-4 text-sm mnx-text-primary">
                <p className="mnx-label mnx-text-danger">
                  Manager approval required
                </p>
                <p className="mt-1 mnx-text-muted">
                  Confirm the exact job number and type{" "}
                  <span className="mnx-text-primary">delete job</span> to
                  execute this deletion request.
                </p>
              </div>
              ...
              <div className="flex flex-wrap justify-end gap-2">
                ...
                <Button
                  disabled={
                    !deleteInputsMatch || loading === "job-delete-approve"
                  }
                  onClick={handleApproveDeletionRequest}
                  className="text-xs uppercase tracking-[0.12em]"
                >
                  {loading === "job-delete-approve"
                    ? "Deleting..."
                    : "Approve & Delete"}
                </Button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap justify-end gap-2">
                ...
                <Button
                  variant="destructive"
                  disabled={
                    !deleteDecisionRemarks.trim() ||
                    loading === "job-delete-reject"
                  }
          ...
          {deleteDocModal && (
            ...
            >
              <div className="space-y-4">
                <p className="text-sm mnx-text-primary">
                  File:{" "}
                  <strong className="mnx-text-muted font-medium">
                    {deleteDocModal.fileName}
                  </strong>
                </p>
                <p className="text-xs mnx-text-danger font-medium">
                  This action is permanent and cannot be undone. If this is a
                  mandatory document requirement, the workflow stage may revert
            ...
            >
              <div className="space-y-4">
                <FileUploadField
                  ...
                  uploading={
                    loading === `doc-${uploadDocumentModalRequirement.id}`
                  }
          ...
          >
            <div className="space-y-5">
              <div className="flex items-start gap-3 rounded-xl border mnx-border-warning mnx-bg-warning px-4 py-3">
                ...
                <div className="min-w-0 space-y-1">
                  <p className="text-sm font-medium mnx-text-primary">
                    Mark {bulkNaEligibleRequirements.length} visible pending
                    document requirement(s) as N/A?
                  </p>
                  <p className="text-xs leading-5 mnx-text-muted">
                    This will record each selected requirement as not available
                    and add an audit entry. Uploaded or already resolved
                    documents will not be changed.
                  </p>
                </div>
              </div>
        ...
        >
          <div className="space-y-5">
            <div className="flex items-start gap-3 rounded-xl border mnx-border-warning mnx-bg-surface px-4 py-3">
              ...
              <div className="min-w-0 space-y-1">
                <p className="text-sm font-medium mnx-text-primary">
                  {activeNodeRun?.node?.name || "This stage"} is waiting on{" "}
                  {(activeNodePrerequisiteStatus?.missingNodeNames || []).join(
                    ", ",
                  ) || "a prerequisite stage"}
                  .
                </p>
                <p className="text-xs leading-5 mnx-text-muted">
                  A skipped prerequisite does not count as completed. Go to the
                  required stage, tick the required work, complete it, then
        ...
        >
          <div className="space-y-4">
            <div className="rounded-xl border mnx-border mnx-bg-soft p-4 text-xs mnx-text-muted">
              This custom document name is job-specific and will appear only
              inside <strong className="mnx-text-primary">this CHA job</strong>,
              under the{" "}
              <strong className="mnx-text-primary">User Uploads</strong>{" "}
              section.
            </div>
            ...
            <div className="space-y-4">
              ...
              <FileUploadField
                ...
                onInputChange={(e) =>
                  setCustomDocumentFile(e.target.files?.[0] || null)
                }
              />
            </div>
      ...
      {viewingVersion && viewingVersion.type === "checklist" && (
        ...
        >
          {(() => {
            const previewUrl =
              previewUrls[viewingVersion.id] || viewingVersion.fileKey || null;
                  ...
                  <>
                    {loadingPreview && (
                      <div className="absolute inset-0 flex flex-col items-center justify-center mnx-bg-surface backdrop-blur-[1px] z-10 gap-3">
                        ...
                        <span className="text-xs mnx-text-muted font-sans">
                          Loading preview...
                        </span>
                      </div>
                    )}
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center p-4 text-center space-y-4">
                    ...
                    <div className="space-y-2 max-w-md">
                      ...
                      <p className="text-xs mnx-text-muted leading-relaxed font-sans">
                        Word, Excel, or binary formats cannot be previewed
                        directly in the browser. You can download this file to
                        view it locally.
                      </p>
                    </div>
                    <div className="p-4 rounded-xl border mnx-border mnx-bg-soft text-left text-xs space-y-2 w-full max-w-md">
                      <p className="font-semibold mnx-text-primary uppercase mnx-label">
                        File Details
                      </p>
                      <div className="grid grid-cols-2 gap-2 mnx-text-muted">
                        <span>Filename:</span>
                        <span className="mnx-text-primary truncate font-sans">
                          {viewingVersion.fileName}
                        </span>
                        <span>Size:</span>
                        <span className="mnx-text-primary mnx-numeric font-sans">
                          {(viewingVersion.sizeBytes / 1024).toFixed(1)} KB
                        </span>
                        <span>Uploaded By:</span>
                        <span className="mnx-text-primary font-sans">
                          {viewingVersion.uploadedBy?.name || "System"}
                        </span>
                        <span>Uploaded At:</span>
                        <span className="mnx-text-primary mnx-numeric font-sans">
                          {viewingVersion.uploadedAt
                            ? new Date(
                                viewingVersion.uploadedAt,
                              ).toLocaleString("en-IN")
                            : "N/A"}
        ...
        >
          <div className="space-y-4 pt-2">
            <p className="text-xs mnx-text-muted font-sans">
              ...
              {section49Flag?.isEnabled ? "deactivate" : "activate"} Section 49
              customs bond filing status? This change will be logged in the
              audit trail.
            </p>
            <div className="space-y-1.5">
