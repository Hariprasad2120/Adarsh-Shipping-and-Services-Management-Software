...
export const metadata = {
  title: "MBL Transaction | Freight Forwarding | Adarsh Shipping",
};

export default async function FreightForwardingMblTransactionPage({
  params,
}: {
  ...
  const transaction = transactions.find(
    (entry) => entry.id === transactionId && entry.transactionType === "MBL",
  );
