        ...
        <svg className="w-full h-full overflow-visible" viewBox="0 0 200 150">
          <defs>
            ...
            <linearGradient id="glassBarGrad" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="25%" stopColor="var(--mnx-graphic-surface)" stopOpacity="0.75" />
            ...
            <linearGradient id="glassBarGradHover" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="30%" stopColor="var(--mnx-graphic-surface)" stopOpacity="0.85" />
              <stop offset="100%" stopColor="var(--mnx-graphic-accent-soft)" stopOpacity="0.5" />
            </linearGradient>
            ...
            <filter id="glassShadow" x="-20%" y="-20%" width="140%" height="140%">
              ...
              <feDropShadow dx="0" dy="2" stdDeviation="2" floodColor="var(--mnx-text)" floodOpacity="0.04" />
            </filter>
          </defs>
