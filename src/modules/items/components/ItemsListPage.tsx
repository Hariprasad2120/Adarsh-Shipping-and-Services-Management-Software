...
import { ItemsToolbar } from "@/modules/items/components/ItemsToolbar";
...
export function ItemsListPage({ basePath = "/crm/items" }: ItemsListPageProps) {
  ...
  return (
    <div className="mnx-item-workspace flex flex-col h-full bg-mono-soft">
      ...
      <div className="flex-1 overflow-hidden flex flex-col bg-mono-card mx-0 rounded-xl border border-[var(--color-outline-variant)]">
        <ItemsTable
          items={paginated}
