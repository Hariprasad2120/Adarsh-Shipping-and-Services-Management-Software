  ...
  return createPortal(
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-md rounded-2xl border border-outline-variant/70 bg-surface px-6 py-7 text-center shadow-[var(--shadow-ambient-hover)]"
      >
        <button
          type="button"
        ...
        <p id="create-job-permission-description" className="mx-auto mt-3 max-w-sm text-sm text-on-surface-variant">
