...
const inputCls =
  "w-full px-3 py-1.5 text-sm border border-[#d9dee7] rounded focus:outline-none focus:border-[#F9D972] focus:ring-1 focus:ring-[#F9D972]/20 text-[#212529] placeholder-[#6b7280] h-[34px] disabled:bg-[#f3f5f8] disabled:cursor-not-allowed disabled:text-[#6b7280]";
