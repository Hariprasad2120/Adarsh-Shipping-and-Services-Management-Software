...
function SidebarTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex size-8 items-center justify-center rounded-[10px] border border-transparent text-[color:var(--mnx-muted)] transition hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring",
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
...
function SidebarMenuSubButton({
  ...
  return "href" in props ? (
    <LinkPrimitive
      ...
      data-size={size}
      data-active={isActive}
      className={cn(sidebarMenuSubButtonClassName, className)}
      {...(props as LinkProps & { href: string })}
    />
  ) : (
    <ButtonPrimitive
