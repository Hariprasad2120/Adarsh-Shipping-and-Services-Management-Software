...
export function FileUploadField({
  ...
  const showInlineClear =
    Boolean(onClear) && (previewInline || previewFiles.length === 1);
        ...
        <>
          ...
          <label
            ...
            className={cn(
              ...
              isDragging &&
                "border-[#00cec4]/70 bg-surface-container-low/40 shadow-[0_0_0_3px_rgba(0,206,196,0.14)]",
          ...
          <div className={previewInline ? "space-y-0" : "space-y-3"}>
            {previewFiles.map((previewFile, index) => {
              const fileHref =
                ...
                previewFile.name === selectedFile?.name
                  ? previewHref
                  : previewFile.href || null;
              const fileSizeLabel =
                previewFiles.length === 1 &&
                previewFile.name === selectedFile?.name
                  ? sizeLabel
