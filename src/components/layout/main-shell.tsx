...
export function MainShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main
      ...
      className="flex min-w-0 flex-1 flex-col overflow-y-auto overflow-x-hidden bg-mono-page pl-0 transition-[padding-left] duration-300 lg:pl-[var(--sidebar-width)]"
