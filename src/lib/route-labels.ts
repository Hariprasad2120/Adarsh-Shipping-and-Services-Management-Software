const PATH_LABELS: Record<string, string> = {
  ...
  "/crm/freight-forwarding": "Freight Forwarding",
  "/crm/customs-clearance": "Customs Clearance",
  "/freight-forwarding": "Freight Forwarding",
  "/freight-forwarding/mbl": "MBL Transactions",
  "/freight-forwarding/hbl": "HBL Transactions",
  "/freight-forwarding/settings": "Settings",
  "/freight-forwarding/settings/data": "Data",
  "/freight-forwarding/create-booking": "Create Booking",
  "/freight-forwarding/create-booking/mbl": "MBL Booking",
  "/freight-forwarding/create-booking/hbl": "HBL Booking",
  "/freight-forwarding/process": "Process",
  ...
  "/cha": "CHA",
  "/cha/jobs": "Jobs",
  "/cha/jobs/new": "New Job",
  "/cha/process": "Process",
  "/cha/approvals": "Checklist Approvals",
  "/cha/expenses": "Expenses",
  "/cha/reports": "Reports",
...
export function getPathLabel(path: string): string | null {
