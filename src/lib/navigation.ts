...
export const NAV_SECTIONS: PrimaryNavSection[] = [
  ...
  },
  {
    ...
    label: "HRMS",
    icon: UserMultiple,
    permission: ["hrms.employee.read", "hrms.workreport.submit", "hrms.travel.request", "hrms.helpdesk.read", "hrms.letters.manage", "hrms.onboarding.manage"],
    matchPaths: ["/hrms"],
    items: [
      {
        href: "/hrms/employees",
      ...
      },
      {
        ...
        label: "Work Reports",
        icon: Report,
        permission: ["hrms.workreport.submit", "hrms.workreport.approve", "hrms.workreport.view_all"],
      ...
      },
      {
        ...
        icon: Security,
        permission: "hrms.approvals.manage",
      ...
      },
      {
        ...
        icon: Calendar,
        permission: ["hrms.travel.request", "hrms.travel.approve"],
      ...
      },
      {
        ...
        label: "HR Letters",
        icon: DocumentAdd,
        permission: "hrms.letters.manage",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Assignments",
        icon: Task,
        permission: ["lms.learning.self", "lms.assignment.manage"],
