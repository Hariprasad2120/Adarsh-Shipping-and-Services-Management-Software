...
export function isWorkingDate(dateKey: string, calendar: WorkingCalendarConfig): boolean {
 ...
 */
export function calendarFromDb(
  record: {
    workStart: string;
    workEnd: string;
    timezone: string;
  ...
  return {
    workStartTime: record.workStart,
    workEndTime: record.workEnd,
    timezone: record.timezone,
    graceMinutes: record.graceMinutes,
    workingDays: record.workingDays
      ? record.workingDays.split(",").map(Number)
