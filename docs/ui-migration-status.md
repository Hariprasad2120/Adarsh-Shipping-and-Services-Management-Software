...
The final repository audit is complete. The protected `/dashboard` visual
reference was verified without redesign and is counted as verified, but not as
a migrated route.

- **Total routes discovered: 213**
- **Total routes migrated: 212**
- **Total routes verified: 213**
- **Routes remaining: 0**
...
- Static route and module verifiers pass; production TypeScript passes; the
  focused final-audit lint set passes; 10 focused UI contract tests pass; and
  the optimized production build passes for all 328 application/API routes.
- Repository-wide lint was run and remains red on the pre-existing business
  code lint backlog. The full test suite was run: 281 tests pass and three
